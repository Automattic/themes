...
<p><strong><?php echo esc_html__( 'Product', 'koinonia' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Explore product', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Pricing', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Integrations', 'koinonia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"1vh"},"typography":{"fontSize":"0.9rem"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group" style="font-size:0.9rem"><!-- wp:paragraph -->
<p><strong><?php echo esc_html__( 'Features', 'koinonia' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Patients', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Health Providers', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Data Tracker', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Medical Records', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Subscriptions', 'koinonia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"1vh"},"typography":{"fontSize":"0.9rem"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group" style="font-size:0.9rem"><!-- wp:paragraph -->
<p><strong><?php echo esc_html__( 'Resources', 'koinonia' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Blog', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Case Studies', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Help', 'koinonia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"1vh"},"typography":{"fontSize":"0.9rem"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group" style="font-size:0.9rem"><!-- wp:paragraph -->
<p><strong><?php echo esc_html__( 'Company', 'koinonia' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'About', 'koinonia' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Careers', 'koinonia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'The future of healthcare®', 'koinonia' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<?php
		$wordpress_link = '<a href="' . esc_url( __( 'https://wordpress.org', 'koinonia' ) ) . '" rel="nofollow">WordPress</a>';
		echo sprintf(
			/* Translators: WordPress link. */
			esc_html__( 'Koinonia Theme · Designed with %1$s', 'koinonia' ),
			$wordpress_link
		);
		?>
</p>
