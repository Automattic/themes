...
<main class="wp-block-query alignwide"><!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"2.1rem","left":"0px"}}},"layout":{"type":"default"}} -->
...
<h2 class="wp-block-heading alignfull" style="text-transform:lowercase"><?php esc_html_e('search', 'massimo');?></h2>
<!-- /wp:heading -->
...
<!-- wp:search {"showLabel":false,"width":100,"widthUnit":"%","buttonPosition":"button-inside","buttonUseIcon":true,"style":{"border":{"radius":"0px","top":{"color":"var:preset|color|secondary","style":"solid","width":"2px"},"right":{"color":"var:preset|color|secondary","style":"solid","width":"2px"},"bottom":{"color":"var:preset|color|secondary","style":"solid","width":"2px"},"left":{"color":"var:preset|color|secondary","style":"solid","width":"2px"}}},"textColor":"background"} /-->
...
<div class="wp-block-group" style="margin-top:2.1rem;margin-bottom:2.1rem"><!-- wp:query-pagination {"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"4rem"}}} -->
