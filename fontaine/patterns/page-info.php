...
<div class="wp-block-group alignfull has-theme-5-background-color has-background" style="min-height:100vh">
	...
	<!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|theme-1"},":hover":{"color":{"text":"var:preset|color|theme-4"}}}}},"textColor":"theme-1","layout":{"type":"default"}} -->
	<div class="wp-block-group has-theme-1-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0">
