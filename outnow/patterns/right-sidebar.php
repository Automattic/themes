...
<h3 class="wp-block-heading" style="font-size:1.4rem;line-height:1">The author</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.2rem","lineHeight":1.6}},"fontFamily":"libre-caslon-text"} -->
<p class="has-libre-caslon-text-font-family" style="font-size:1.2rem;line-height:1.6"><a href="https://outnow.mystagingwebsite.com/about/" data-type="page" data-id="2">Ernest M. Hemingway was an American novelist, short-story writer, journalist, and sportsman.</a></p>
<!-- /wp:paragraph -->

<!-- wp:image {"id":220,"width":96,"height":96,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/cropped-outnow_image-author.jpg" alt="" class="wp-image-220" width="96" height="96"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading" style="padding-left:1rem;font-size:1.4rem;line-height:1">Related posts</h3>
<!-- /wp:heading -->
