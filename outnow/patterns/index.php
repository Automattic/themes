...
<!-- wp:group {"metadata":{"name":"Content"},"align":"full","style":{"spacing":{"padding":{"bottom":"5rem","right":"2rem","left":"2rem"},"blockGap":"2rem"}},"layout":{"type":"constrained"}} -->
...
<!-- wp:group {"metadata":{"name":"Post template wrapper"},"style":{"spacing":{"blockGap":"1rem","margin":{"bottom":"5rem"}}},"layout":{"type":"constrained"}} -->
...
<p class="has-libre-franklin-font-family" style="font-size:0.8rem;letter-spacing:0.02rem"><?php esc_html_e('·', 'outnow');?></p>
<!-- /wp:paragraph -->
