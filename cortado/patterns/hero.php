...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:image {"id":420,"height":620,"aspectRatio":"3/4","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/foodiesfeed.com_coffee-beans-falling_web.jpg" alt="" class="wp-image-420" style="aspect-ratio:3/4;object-fit:cover;height:620px" height="620"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<p><?php echo esc_html__( 'Everyday 7am - 6pm', 'cortado' ); ?><br><?php echo esc_html__( '617 000 0000', 'cortado' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
