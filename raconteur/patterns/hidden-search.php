	...
	<div class="wp-block-group" style="min-height:100vh">
		...
		<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--70);margin-bottom:var(--wp--preset--spacing--70)">
			...
			<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--70)">
				...
				<!-- wp:search {"label":"","showLabel":false,"placeholder":"<?php echo esc_html_x( 'Search...', 'This is a placeholder text in a search field', 'raconteur' ); ?>","buttonText":"","buttonUseIcon":true} /-->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-query">
				<!-- wp:query-no-results -->
					<!-- wp:paragraph -->
					<p><?php echo esc_html_x( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'Message explaining that there are no results returned from a search', 'raconteur' ); ?></p>
					<!-- /wp:paragraph -->
				<!-- /wp:query-no-results -->
		...
		<!-- wp:pattern {"slug":"raconteur/footer"} /-->
	</div>
	<!-- /wp:group -->
</div>
<!-- /wp:column -->
