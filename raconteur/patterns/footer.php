...
<div class="wp-block-group has-contrast-color has-text-color has-link-color" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group">
		...
		<p class="no-underline has-x-small-font-size"><?php echo __('<a href="#">Instagram</a> / <a href="#">TikTok</a> / <a href="#">X</a>', 'raconteur');?></p>
		<!-- /wp:paragraph -->

		<!-- wp:paragraph {"lock":{"move":false,"remove":true},"className":"no-underline","fontSize":"x-small"} -->
		<p class="no-underline has-x-small-font-size"><?php echo __('Designed with <a href="https://wordpress.org" rel="nofollow">WordPress</a>', 'raconteur');?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
