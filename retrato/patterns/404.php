...
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color has-link-color has-instrument-serif-font-family" id="oops-that-page-can-t-be-found" style="font-size:6rem;font-style:normal;font-weight:400"><?php echo esc_html__( 'Oh, sorry... 404.', 'retrato' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'That page can’t be found.', 'retrato' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'It looks like nothing was found at this location. Maybe try a search?', 'retrato' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
