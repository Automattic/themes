...
<h3 class="wp-block-heading" style="font-size:1.4rem;line-height:1"><?php echo __('The author', 'retrato');?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.2rem","lineHeight":1.6000000000000001}},"fontFamily":"libre-caslon-text"} -->
<p class="has-libre-caslon-text-font-family" style="font-size:1.2rem;line-height:1.6"><?php echo __('<a href="/" data-type="page" data-id="2">Ernest M. Hemingway was an American novelist, short-story writer, journalist, and sportsman.</a>', 'retrato');?></p>
<!-- /wp:paragraph -->
...
<h3 class="wp-block-heading" style="padding-left:1rem;font-size:1.4rem;line-height:1"><?php echo __('Related posts', 'retrato');?></h3>
<!-- /wp:heading -->

<!-- wp:query {"queryId":0,"query":{"perPage":"3","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[]},"tagName":"main","align":"wide","layout":{"type":"constrained"}} -->
...
<p style="line-height:1"><?php echo __('/', 'retrato');?></p>
<!-- /wp:paragraph -->
