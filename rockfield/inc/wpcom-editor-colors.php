...
add_editor_color_rule( 'link', '#222222', array(
	...
	// Text-color
	array( '#editor .editor-styles-wrapper .wp-block.is-style-outline .wp-block-button__link:not(.has-text-color),
...
add_editor_color_rule( 'fg1', '#116821', array(
