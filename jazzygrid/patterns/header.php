...
<p class="has-small-font-size"><?php esc_html_e('<a href="#" target="_blank" rel="noreferrer noopener">Website</a>', 'jazzygrid');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('<a href="#" target="_blank" rel="noreferrer noopener">Albums</a>', 'jazzygrid');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('<a href="#" target="_blank" rel="noreferrer noopener">Tickets</a>', 'jazzygrid');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->