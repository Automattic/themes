 ...
 * @return void
 */
function vetro_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'vetro' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'vetro' ) ),
		'header'   => array( 'label' => __( 'Headers', 'vetro' ) ),
		'query'    => array( 'label' => __( 'Query', 'vetro' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'vetro' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'vetro_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'vetro_block_patterns', $block_patterns );
...
add_action( 'init', 'vetro_register_block_patterns', 9 );
