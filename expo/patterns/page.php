...
<h2 class="wp-block-heading has-small-font-size" style="margin-top:0;font-style:normal;font-weight:700;line-height:1;text-transform:uppercase"><?php echo __('Archive', 'expo');?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading {"style":{"spacing":{"margin":{"top":"0"},"blockGap":"0px"},"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"700","lineHeight":"1"}},"fontSize":"small"} -->
<h2 class="wp-block-heading has-small-font-size" style="margin-top:0;font-style:normal;font-weight:700;line-height:1;text-transform:uppercase"><?php echo __('Categories', 'expo');?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading {"style":{"spacing":{"margin":{"top":"0"},"blockGap":"0px"},"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"700","lineHeight":"1"}},"fontSize":"small"} -->
<h2 class="wp-block-heading has-small-font-size" style="margin-top:0;font-style:normal;font-weight:700;line-height:1;text-transform:uppercase"><?php echo __('Newsletter', 'expo');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo __('Want to subscribe to our newsletter? <span style="text-decoration: underline;"><a href="#">Sign up here</a></span>.', 'expo');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
