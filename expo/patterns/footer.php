...
<h3 class="wp-block-heading"><?php echo __('Visiting the Museum', 'expo');?></h3>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading"><?php echo __('Opening times', 'expo');?></h3>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading"><?php echo __('Group Visits', 'expo');?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-small-font-size"><?php echo __('Audioguide', 'expo');?></h3>
<!-- /wp:heading -->
