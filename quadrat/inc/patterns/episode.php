...
return array(
	...
	'content'    => '<!-- wp:media-text {"mediaId":1497,"mediaLink":"' . get_stylesheet_directory_uri() . '/assets/illustrations/introspection-scaled.jpeg","mediaType":"image","mediaWidth":40,"mediaSizeSlug":"large","imageFill":false,"className":"has-primary-color has-secondary-background-color has-text-color has-background is-style-default"} -->
	<div class="wp-block-media-text alignwide is-stacked-on-mobile has-primary-color has-secondary-background-color has-text-color has-background is-style-default" style="grid-template-columns:41% auto"><figure class="wp-block-media-text__media"><img src="' . get_stylesheet_directory_uri() . '/assets/illustrations/introspection-scaled.jpeg" alt="' . esc_attr__( 'Illustration of an introspective woman.', 'quadrat') . '" class="wp-image-1497 size-large"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"level":3} -->
