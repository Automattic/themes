		...
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				...
				array(
					...
					'content'    => '<!-- wp:media-text {"mediaId":1559,"mediaLink":"http://localhost:4759/?attachment_id=1559","mediaType":"image","mediaWidth":40,"backgroundColor":"darker-blue","textColor":"pink"} -->
					<div class="wp-block-media-text alignwide is-stacked-on-mobile has-pink-color has-darker-blue-background-color has-text-color has-background" style="grid-template-columns:40% auto"><figure class="wp-block-media-text__media"><img src="http://localhost:4759/wp-content/uploads/2021/04/Introspection-scaled-1-1024x914.jpeg" alt="" class="wp-image-1559 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"level":3} -->
					<h3>' . esc_html__( 'Episode 3: A Cycle of Emotions', 'quadrat' ) . '</h3>
					<!-- /wp:heading -->
					<!-- wp:paragraph {"fontSize":"small"} -->
					<p class="has-small-font-size">' . esc_html__( '“Do we need periods if they make us crazy?”, Sarah asks. We reached out to our friend Diana Roth, an endocrinologist specialized in women’s hormonal health to know how menstrual cycles impact women’s brains and emotions. Hint: yes, we do.', 'quadrat' ) . '</p>
					<!-- /wp:paragraph --></div></div>
					<!-- /wp:media-text -->',
				)
			);
