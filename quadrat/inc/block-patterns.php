		...
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				...
				array(
					...
					'categories' => array( 'quadrat' ),
					'content'    => '<!-- wp:cover {"overlayColor":"darker-blue","align":"wide","className":"is-style-quadrat-cover-diamond"} -->
					<div class="wp-block-cover alignwide has-darker-blue-background-color has-background-dim is-style-quadrat-cover-diamond"><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","textColor":"pink"} -->
