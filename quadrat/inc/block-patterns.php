		...
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				...
				array(
					...
					<div class="wp-block-columns alignwide are-vertically-aligned-center has-background-no-padding has-pink-color has-darker-blue-background-color has-text-color has-background"><!-- wp:column {"verticalAlignment":"center","width":"40%"} -->
