 ...
 */
?>
<!-- wp:template-part {"slug":"header","theme":"brute","tagName":"header"} /-->
...
<h1 class="wp-block-heading" style="font-size:4rem;line-height:1">Strength</h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h1 class="wp-block-heading" style="font-size:4rem;line-height:1">In simplicity</h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column -->
...
<h3 class="wp-block-heading" style="line-height:1.3;text-transform:none">An architectural style that emerged in the mid-20s is based in brute and unadorned use of concrete.</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Named by the French term <em>béton brut</em>, or <em>brute concrete</em>, Brutalism became popular in the post-WWII era, when the need for affordable housing and public buildings led to the widespread use of concrete.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
...
<h1 class="wp-block-heading has-text-align-center">Celebrated by their <em>use of concrete</em> and <em>geometric forms</em>, Some architects associated to Brutalism include:</h1>
<!-- /wp:heading -->
...
<!-- wp:query {"queryId":0,"query":{"perPage":"3","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"category":[7]},"parents":[]},"tagName":"main","displayLayout":{"type":"flex","columns":3},"align":"wide","layout":{"inherit":true,"type":"constrained"}} -->
...
<figure class="wp-block-image aligncenter size-full is-resized"><a href="https://brute.mystagingwebsite.com/page/"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/btn_plus.png" alt="" class="wp-image-161" width="64" height="64"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<h1 class="wp-block-heading alignwide">Six most appreciated Brutalist buildings</h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p class="has-medium-font-size">Brutalism was also influenced by the work of the Bauhaus school, which emphasized functionalism and simplicity in design.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<p class="has-medium-font-size">Brutalism in Architecture express the essential qualities of a building’s materials and structure in an honest and direct way.<br>Architectural style emerged in mid-20s, based in brute and unadorned use of concrete.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Named by the French term béton brute, or brute concrete, Brutalism became popular in the post-WWII era, when the need for affordable housing and public buildings led to widespread use of concrete.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:template-part {"slug":"footer","theme":"brute","tagName":"footer"} /-->