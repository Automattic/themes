...
<div class="wp-block-columns alignwide">
	...
	<div class="wp-block-column">
		...
		<p class="has-small-font-size" style="margin-top:var(--wp--preset--spacing--30);letter-spacing:0.04em;text-transform:uppercase"><?php echo esc_html__( 'Course preview', 'margarethe' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:column -->
	...
	<div class="wp-block-column" style="flex-basis:65.16%">
		...
		<h2 class="wp-block-heading has-xxx-large-font-size" style="line-height:1.05;text-transform:none"><?php echo esc_html__( 'Success Synergy: Bridging passion, purpose, and performance', 'margarethe' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:column -->
</div>
...
<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-column">
		<!-- wp:paragraph -->
		<p><?php echo esc_html__( 'This snippet showcases our course, merging passion with purpose for peak performance. Discover techniques empowering many to elevate their life and work. Experience success synergy and see the potential ahead.', 'margarethe' ); ?></p>
		<!-- /wp:paragraph -->
