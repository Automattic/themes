...
<div class="wp-block-columns alignwide">
	...
	<div class="wp-block-column" style="flex-basis:65.16%">
		...
		<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/margarethe-img-9.jpg" alt="<?php esc_attr_e( 'Portrait of smiling blonde woman with long hair', 'margarethe' ); ?>"/></figure>
		<!-- /wp:image -->
	</div>
	<!-- /wp:column -->
