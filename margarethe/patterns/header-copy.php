...
<div class="wp-block-group alignwide"><!-- wp:navigation {"ref":4,"overlayBackgroundColor":"base","overlayTextColor":"primary","align":"wide","layout":{"type":"flex","justifyContent":"right"},"style":{"spacing":{"blockGap":"var:preset|spacing|50"}}} /-->
...
<p class="has-small-font-size" style="margin-top:var(--wp--preset--spacing--30);letter-spacing:0.04em;text-transform:uppercase">What I do</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-xxxx-large-font-size" style="line-height:1.1">I’m an interior designer based in Antwerp.</h2>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
