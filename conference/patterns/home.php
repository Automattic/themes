...
<main class="wp-block-group has-primary-background-color has-background" style="margin-top:0rem;margin-bottom:0rem"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Photoreal_image_of_the_auditory_of_a_conference_based__863cd490-c3a3-4a1b-8dac-92ce3823e4be.jpg","dimRatio":10,"overlayColor":"contrast","isUserOverlayColor":true,"focalPoint":{"x":0.5,"y":0.59999999999999998},"minHeight":50,"minHeightUnit":"vh","contentPosition":"top center","isDark":false,"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"0","bottom":"0"}},"border":{"left":{"color":"var:preset|color|primary","width":"1rem"},"right":{"color":"var:preset|color|primary","width":"1rem"}},"color":[]},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull is-light has-custom-content-position is-position-top-center" style="border-right-color:var(--wp--preset--color--primary);border-right-width:1rem;border-left-color:var(--wp--preset--color--primary);border-left-width:1rem;margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0;min-height:50vh"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-10 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Photoreal_image_of_the_auditory_of_a_conference_based__863cd490-c3a3-4a1b-8dac-92ce3823e4be.jpg" style="object-position:50% 60%" data-object-fit="cover" data-object-position="50% 60%"/><div class="wp-block-cover__inner-container"><!-- wp:columns {"align":"wide"} -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/A_portrait_of_this_group_of_people_in_their_thirties_d_0b80e5b2-876f-46cd-8755-907f92006f4c-e1697031208711.jpg" alt="" style="border-radius:2px;border-bottom-color:var(--wp--preset--color--secondary);border-bottom-width:0.5rem;aspect-ratio:4/3;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0.5rem","padding":{"top":"0.5em","bottom":"0.5em"}}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
...
<!-- wp:group {"style":{"layout":{"selfStretch":"fit","flexSize":null},"dimensions":{"minHeight":"20px"},"spacing":{"padding":{"top":"0.5rem","bottom":"0.5rem","left":"0.5rem","right":"0.5rem"}},"border":{"radius":"50px"},"typography":{"lineHeight":"0"}},"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"aspectRatio":"4/3","scale":"cover","sizeSlug":"full","linkDestination":"custom","style":{"border":{"radius":"2px","bottom":{"color":"var:preset|color|secondary","width":"0.5rem"},"top":[],"right":[],"left":[]}}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/A_group_of_person_in_their_thirties_on_a_conference_br_280fdd12-710c-4845-8fdc-e993a493ea9f.jpg" alt="" style="border-radius:2px;border-bottom-color:var(--wp--preset--color--secondary);border-bottom-width:0.5rem;aspect-ratio:4/3;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"aspectRatio":"4/3","scale":"cover","sizeSlug":"full","linkDestination":"custom","style":{"border":{"radius":"2px","bottom":{"color":"var:preset|color|secondary","width":"0.5rem"},"top":[],"right":[],"left":[]}}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/A_group_of_person_in_their_thirties_on_a_conference_ha_3edcf257-8384-4911-9a23-ed7031bd48c6.jpg" alt="" style="border-radius:2px;border-bottom-color:var(--wp--preset--color--secondary);border-bottom-width:0.5rem;aspect-ratio:4/3;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:32%"><!-- wp:image {"aspectRatio":"3/4","scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"2px","bottom":{"color":"var:preset|color|secondary","width":"0.5rem"},"top":[],"right":[],"left":[]},"color":[]}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Photoreal_image_of_a_woman_walking_on_a_beach_in_Icela_2d1fb6b3-12c9-4be6-a8ed-9384d4cffc97.jpg" alt="" style="border-radius:2px;border-bottom-color:var(--wp--preset--color--secondary);border-bottom-width:0.5rem;aspect-ratio:3/4;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"top"} -->
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:group {"style":{"spacing":{"blockGap":"3rem"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading"><?php esc_html_e('The International Conference Centre in Reykjavík, Iceland', 'conference');?></h1>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.05rem","fontStyle":"normal","fontWeight":"700","textDecoration":"none"},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast","fontSize":"x-small"} -->
<p class="has-contrast-color has-text-color has-link-color has-x-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:0.05rem;text-decoration:none;text-transform:uppercase"><?php esc_html_e('All sponsors', 'conference');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.05rem","fontStyle":"normal","fontWeight":"700","textDecoration":"none"},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast","fontSize":"x-small"} -->
<p class="has-contrast-color has-text-color has-link-color has-x-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:0.05rem;text-decoration:none;text-transform:uppercase"><?php esc_html_e('↗', 'conference');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0.5rem"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.05rem","fontStyle":"normal","fontWeight":"700","textDecoration":"none"},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast","fontSize":"x-small"} -->
<p class="has-contrast-color has-text-color has-link-color has-x-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:0.05rem;text-decoration:none;text-transform:uppercase"><?php esc_html_e('Go to Blog', 'conference');?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull has-contrast-color has-default-gradient-gradient-background has-text-color has-background has-link-color" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Photoreal_image_of_this_beach_in_Iceland_4406f604-9450-45e6-8f00-5c643638bb93-e1697031007354.jpg","dimRatio":0,"minHeight":40,"minHeightUnit":"vh","align":"wide","style":{"color":[],"elements":{"link":{"color":{"text":"var:preset|color|base"}}},"spacing":{"padding":{"top":"2rem","bottom":"2rem","left":"1.5%","right":"1.5%"}},"border":{"radius":"2px"}},"textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignwide has-base-color has-text-color has-link-color" style="border-radius:2px;padding-top:2rem;padding-right:1.5%;padding-bottom:2rem;padding-left:1.5%;min-height:40vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Photoreal_image_of_this_beach_in_Iceland_4406f604-9450-45e6-8f00-5c643638bb93-e1697031007354.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"center","align":"wide"} -->
<div class="wp-block-columns alignwide are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"30.3%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30.3%"><!-- wp:heading {"level":1,"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<h1 class="wp-block-heading has-base-color has-text-color has-link-color"><?php esc_html_e('Reserve your tickets today', 'conference');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<h3 class="wp-block-heading"><?php esc_html_e('Be part of this transformative conference that will elevate and inspire your work. Reserve your spot today and prepare for an unforgettable experience!', 'conference');?></h3>
<!-- /wp:heading -->
