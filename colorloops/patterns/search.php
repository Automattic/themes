...
<main class="wp-block-group alignfull" style="min-height:1px"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"bottom":"3.03rem"}}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group alignwide" style="padding-bottom:3.03rem"><!-- wp:search {"showLabel":false,"placeholder":"Search","width":75,"widthUnit":"%","buttonPosition":"button-inside","buttonUseIcon":true,"style":{"border":{"width":"0px","style":"none"}}} /--></div>
<!-- /wp:group -->
