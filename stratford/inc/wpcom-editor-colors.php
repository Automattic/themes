...
add_editor_color_rule( 'bg', '#FFFFFF', array(
	...
	array( '#editor .editor-styles-wrapper .has-background-color[class],
			...
			#editor .editor-styles-wrapper .wp-block .has-secondary-background-color[class]', 'color' ),
	// Background-color
	...
	array( '#editor .editor-styles-wrapper .wp-block-quote,
			...
			#editor .editor-styles-wrapper .wp-block-quote[style*="text-align:right"]', 'border-color', '+1' ),
...
add_editor_color_rule( 'link', '#2C313F', array(
	...
	array( '#editor .editor-styles-wrapper .button.has-focus,
			...
			#editor .editor-styles-wrapper .wp-block-search .wp-block-search__button:focus,
			#editor .editor-styles-wrapper .wp-block-search .wp-block-search__button:hover,
			#editor .editor-styles-wrapper .wp-block-search .wp-block-search__button:visited', 'background-color' ),
...
add_editor_color_rule( 'txt', '#74767e', array(
