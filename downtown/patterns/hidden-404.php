...
<h2 class="alignwide has-text-align-left has-text-align-center" style="font-size:8rem;font-style:normal;font-weight:600;line-height:1"><?php echo esc_html__( 'Oops...', 'downtown' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-left has-small-font-size" style="font-style:normal;font-weight:500;line-height:1.4"><?php echo esc_html__( 'This page could not be found.', 'downtown' ); ?><br><?php echo esc_html__( 'Maybe try a search?', 'downtown' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:search {"label":"<?php echo esc_html__( 'Search', 'downtown' ); ?>","showLabel":false,"width":100,"widthUnit":"%","buttonText":"<?php echo esc_html__( 'Search', 'downtown' ); ?>","buttonUseIcon":true,"align":"center","style":{"border":{"radius":"4px","width":"1px"}},"backgroundColor":"foreground","textColor":"background"} /--></div>
<!-- /wp:group -->
