...
<p class="has-text-align-left has-golos-text-font-family" style="font-size:12px;font-style:normal;font-weight:500;line-height:1"><?php echo __('Active Crowdfunding — Join now!', 'moviescript');?></p>
<!-- /wp:paragraph -->
