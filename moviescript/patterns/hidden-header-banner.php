...
<p class="has-text-align-left has-golos-text-font-family" style="font-size:12px;font-style:normal;font-weight:500;line-height:1"><?php echo esc_html__( 'CROWDFUNDING AVAILABLE — Join now!', 'moviescript' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-golos-text-font-family" style="font-size:12px;font-style:normal;font-weight:500;line-height:1;text-transform:uppercase"><?php echo esc_html__( 'Share', 'moviescript' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->