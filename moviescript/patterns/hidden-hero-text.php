 ...
 * Slug: moviescript/hidden-hero-text
 * Inserter: no
 */
?>
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Script by:', 'moviescript' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'A celebrated artificial intelligence chatbot platform launched in late 2022.', 'moviescript' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"33.33%"} -->
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:heading -->
<h2 class="wp-block-heading"><?php echo esc_html__( 'Directed by:', 'moviescript' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:column {"width":"33.33%"} -->
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:heading -->
<h2 class="wp-block-heading"><?php echo esc_html__( 'Produced by:', 'moviescript' ); ?></h2>
<!-- /wp:heading -->
