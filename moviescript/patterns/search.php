...
<div class="wp-block-column" style="flex-basis:28.33%"><!-- wp:search {"showLabel":false,"buttonPosition":"button-inside","buttonUseIcon":true} /--></div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="flex-basis:66.66%"><!-- wp:query-title {"type":"search","textAlign":"center","fontSize":"small"} /-->
...
<h1 class="wp-block-heading has-text-align-center has-small-font-size" style="text-transform:uppercase"><?php echo __('Sorry, but nothing matched your search terms.', 'moviescript');?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo __('Please try again with some different keywords.', 'moviescript');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
