...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:group {"align":"wide","style":{"border":{"top":{"width":"1px"}},"spacing":{"padding":{"top":"1rem"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide" style="border-top-width:1px;padding-top:1rem"><!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"padding":{"top":"8px","bottom":"8px"},"blockGap":{"top":"0rem"}}}} -->
...
<p class="has-text-align-left"><?php esc_html_e('Spark your creativity. Enjoy.', 'moviescript');?></p>
<!-- /wp:paragraph -->
