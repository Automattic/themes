...
<div class="wp-block-group alignwide"><!-- wp:post-excerpt {"textAlign":"center","moreText":"<?php echo esc_html__( 'Read more', 'curator' ); ?>","style":{"spacing":{"padding":{"top":"1rem"}},"typography":{"lineHeight":"1.2"}},"className":"hero-post-excerpt"} /--></div>
<!-- /wp:group -->
