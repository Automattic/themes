...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/smoothie.png" alt="<?php echo esc_attr__( 'Two cups of smoothies topped with chia seeds, accompanied by a spoon full of peanut butter.', 'curator' ); ?>"/></figure>
<!-- /wp:image -->
