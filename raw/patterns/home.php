 ...
 */
?>
<!-- wp:template-part {"slug":"header","theme":"raw","tagName":"header"} /-->
...
<h3 class="wp-block-heading" style="line-height:1.3;text-transform:none">An architectural style that emerged in the mid-20s is based in raw and unadorned use of concrete.</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Named by the French term <em>béton brut</em>, or <em>raw concrete</em>, Brutalism became popular in the post-WWII era, when the need for affordable housing and public buildings led to the widespread use of concrete.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
...
<p class="has-medium-font-size">Brutalism in Architecture express the essential qualities of a building’s materials and structure in an honest and direct way.<br>Architectural style emerged in mid-20s, based in raw and unadorned use of concrete.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Named by the French term béton raw, or raw concrete, Brutalism became popular in the post-WWII era, when the need for affordable housing and public buildings led to widespread use of concrete.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:template-part {"slug":"footer","theme":"raw","tagName":"footer"} /-->