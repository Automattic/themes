...
<div class="wp-block-group alignwide" style="padding-top:0.5rem;padding-right:0rem;padding-bottom:0.5rem;padding-left:0rem"><!-- wp:site-title {"className":"no-underline"} /-->

<!-- wp:navigation {"overlayMenu":"never","style":{"spacing":{"margin":{"top":"0"},"blockGap":""},"layout":{"selfStretch":"fit","flexSize":null}},"layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"space-between","orientation":"horizontal"}} /--></div>
<!-- /wp:group -->
...
<h1 class="wp-block-heading"><?php esc_html_e('Global run, September 20: Take action.', 'happening');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p class="has-text-align-left has-small-font-size" style="line-height:1;text-transform:uppercase"><?php esc_html_e('Designed with WordPress', 'happening');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></main>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->