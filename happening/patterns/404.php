...
<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"0rem","padding":{"top":"0.5rem","right":"0rem","bottom":"0.5rem","left":"0rem"}},"border":{"top":{"width":"2px"},"right":[],"bottom":[],"left":[]}},"layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
<div class="wp-block-group alignwide" style="border-top-width:2px;padding-top:0.5rem;padding-right:0rem;padding-bottom:0.5rem;padding-left:0rem"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","lineHeight":"1"}}} -->
<p style="line-height:1;text-transform:uppercase"><?php esc_html_e('28 Mar 2023, Worldwide.', 'happening');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h1 class="wp-block-heading"><?php esc_html_e('No page was found.', 'happening');?></h1>
<!-- /wp:heading -->

<!-- wp:group {"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"align":"left"} -->
<p class="has-text-align-left"><?php esc_html_e('Maybe try a new search?', 'happening');?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-small-font-size" style="line-height:1;text-transform:uppercase"><?php esc_html_e('Designed with &lt;a href="#" rel="nofollow"&gt;WordPress&lt;/a&gt;.', 'happening');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->