...
<div class="wp-block-cover alignfull has-base-color has-text-color" style="margin-top:0px;margin-bottom:0px;padding-top:3rem;padding-right:6rem;padding-bottom:3rem;padding-left:6rem;min-height:100vh"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background" alt="<?php esc_attr_e( 'Distorted image of a man running from above', 'happening' ); ?>" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/image-from-rawpixel-id-5922463_distorted.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"bottom":"1rem","top":"1rem"},"margin":{"top":"0rem","bottom":"6rem"}},"border":{"top":{"width":"0.3rem"},"bottom":{"width":"0.3rem"}}},"layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
