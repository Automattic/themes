...
<h1 class="wp-block-heading"><?php echo __('Global run, September 20: Take action.', 'happening');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
