...
<figure class="wp-block-image size-full is-resized"><a href="https://texty.mystagingwebsite.com/"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/texty_brand_black.png" alt="" class="wp-image-594" width="48"/></a></figure>
<!-- /wp:image -->

<!-- wp:navigation {"ref":52,"overlayMenu":"never","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"stretch","orientation":"vertical"},"style":{"typography":{"fontStyle":"normal","fontWeight":"500","lineHeight":"1","fontSize":"1.8rem"},"spacing":{"blockGap":"0.2rem"}}} /--></div>
<!-- /wp:group -->

<!-- wp:navigation {"ref":413,"overlayMenu":"never","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"left","orientation":"vertical"},"style":{"typography":{"fontStyle":"normal","fontWeight":"500","lineHeight":"1","fontSize":"1.2rem"},"spacing":{"blockGap":"0.5rem"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
