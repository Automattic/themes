...
<h2 class="wp-block-heading">Download Texty</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"3.2rem","lineHeight":"1.2"}}} -->
<p style="font-size:3.2rem;line-height:1.2">Texty is a magazine-style theme design that displays blog posts, reviews, and news in an original way.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"3.2rem","lineHeight":"1.2"}}} -->
<p style="font-size:3.2rem;line-height:1.2">Texty comes with different style variations to spark your creativity in making it just as you'd like to. Enjoy!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"2rem","lineHeight":"1.4"}}} -->
<p class="has-text-align-left" style="font-size:2rem;line-height:1.4">Designed with <a rel="nofollow" href="https://wordpress.org">WordPress</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<p style="font-size:2rem;line-height:1.4">Month Discover — Incoming Tide, Scarboro, Maine (1883) by&nbsp;<a href="https://artvee.com/artist/winslow-homer/" target="_blank" rel="noreferrer noopener">Winslow Homer</a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
