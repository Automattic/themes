<?php
/**
 * Title: wp-custom-template-courses
 * Slug: coachava/wp-custom-template-courses
 * Categories: hidden
 * Inserter: no
 */
?>
...
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:group {"style":{"spacing":{"blockGap":"2.5rem"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group"><!-- wp:post-content {"lock":{"move":false,"remove":false},"align":"wide","layout":{"type":"constrained","justifyContent":"left"}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p style="font-size:0.9rem;font-style:normal;font-weight:300;letter-spacing:0.07rem;text-transform:uppercase">Courses</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="margin-top:0rem;margin-bottom:0rem"><!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"","margin":{"top":"0rem","bottom":"0rem"},"padding":{"top":"7.5rem","bottom":"7.5rem"}},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"backgroundColor":"tertiary","textColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-contrast-color has-tertiary-background-color has-text-color has-background has-link-color" style="margin-top:0rem;margin-bottom:0rem;padding-top:7.5rem;padding-bottom:7.5rem"><!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"blockGap":{"top":"2rem","left":"2rem"}}}} -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":406,"aspectRatio":"4/3","scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"2px"}}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/pexels-ekaterina-bolovtsova-4049992.jpg" alt="" class="wp-image-406" style="border-radius:2px;aspect-ratio:4/3;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
