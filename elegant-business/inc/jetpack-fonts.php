...
add_filter( 'typekit_add_font_category_rules', function( $category_rules ) {
	...
	TypekitTheme::add_font_category_rule( $category_rules, 'body-text',
		'body',
		array(
			array( 'property' => 'font-family', 'value' => '"Source Serif Pro", "Baskerville Old Face", Garamond, "Times New Roman", serif' ),
	...
	TypekitTheme::add_font_category_rule( $category_rules, 'body-text',
		...
		array(
			array( 'property' => 'font-family', 'value' => '-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Cantarell", "Fira Sans", "Droid Sans", "Helvetica Neue", sans-serif' ),
		)
	);
