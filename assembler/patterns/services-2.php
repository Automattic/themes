...
/**
 * Title: Services 2
 * Slug: assembler/services-2
 * Categories: services
 */
declare( strict_types = 1 );
?>

<!-- wp:group {"metadata":{"name":"Services","patternName":"assembler/services-1"},"align":"full","className":"alignfull is-style-default","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained","justifyContent":"center"}} -->
...
<!-- wp:heading {"align":"wide","style":{"layout":{"selfStretch":"fixed","flexSize":"100%"}}} -->
