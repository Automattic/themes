...
/**
 * Title: Services 5
 * Slug: assembler/services-5
 * Categories: services
 */
declare( strict_types = 1 );
?>

<!-- wp:group {"metadata":{"name":"Services"},"align":"full","className":"alignfull is-style-default","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained","justifyContent":"center"}} -->
...
<!-- wp:columns {"metadata":{"name":"Items"},"align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|40","left":"var:preset|spacing|30"}}}} -->
...
<!-- wp:paragraph -->
<p>Adding services to your website helps provide value by addressing specific needs or challenges that your clients face. Offer expertise, streamline processes, and create tailored solutions that enhance customer satisfaction.</p>
<!-- /wp:paragraph -->
