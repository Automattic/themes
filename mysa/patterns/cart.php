...
<h1 class="wp-block-heading alignwide"><?php echo esc_html__( 'Cart', 'mysa' ); ?></h1>
<!-- /wp:heading -->
...
<div class="wp-block-woocommerce-cart alignwide is-loading">
	...
	<div class="wp-block-woocommerce-filled-cart-block alignwide">
		...
		<div class="wp-block-woocommerce-cart-items-block">
			...
			<div class="wp-block-woocommerce-cart-cross-sells-block">
				...
				<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'You may be interested in…', 'mysa' ); ?></h2>
				<!-- /wp:heading -->
	...
	<div class="wp-block-woocommerce-empty-cart-block alignwide">
		...
		<h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php echo esc_html__( 'Your cart is currently empty!', 'mysa' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><a href="#"><?php echo esc_html__( 'Browse store', 'mysa' ); ?></a></p>
		<!-- /wp:paragraph -->
		...
		<h2 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'New in store', 'mysa' ); ?></h2>
		<!-- /wp:heading -->
