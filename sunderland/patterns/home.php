...
<ul class="wp-block-social-links has-small-icon-size has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"https://momentum.mystagingwebsite.com","service":"soundcloud"} /-->

<!-- wp:social-link {"url":"https://momentum.mystagingwebsite.com","service":"bandcamp"} /-->

<!-- wp:social-link {"url":"https://momentum.mystagingwebsite.com","service":"spotify"} /-->

<!-- wp:social-link {"url":"https://momentum.mystagingwebsite.com","service":"instagram"} /--></ul>
<!-- /wp:social-links --></div>
<!-- /wp:group -->
