...
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/StockSnap_R0C7A5M4WB_duo.png","id":51,"dimRatio":0,"contentPosition":"center left","isDark":false,"align":"wide","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"},"margin":{"top":"0px","bottom":"0px"}},"color":[]},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignwide is-light has-custom-content-position is-position-center-left" style="margin-top:0px;margin-bottom:0px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-51" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/StockSnap_R0C7A5M4WB_duo.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"right":"4rem","top":"0rem","bottom":"0rem","left":"0rem"}}},"layout":{"type":"constrained","justifyContent":"left"}} -->
