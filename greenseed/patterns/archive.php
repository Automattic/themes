...
<main class="wp-block-group" style="margin-top:0px;margin-bottom:0px"><!-- wp:spacer {"height":"var:preset|spacing|80","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
...
<div class="wp-block-query"><!-- wp:query-title {"type":"archive","level":2} /-->
...
<div class="wp-block-group" style="margin-top:0px;margin-bottom:0px"><!-- wp:template-part {"slug":"footer","area":"footer"} /--></div>
<!-- /wp:group -->
