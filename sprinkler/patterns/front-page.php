...
<div class="wp-block-cover alignfull has-tertiary-color has-text-color has-link-color" style="padding-right:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background" alt="<?php esc_html_e('', 'sprinkler');?>" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/image_3-scaled.jpg" style="object-position:67% 40%" data-object-fit="cover" data-object-position="67% 40%"/><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"left","align":"wide","fontSize":"large"} -->
