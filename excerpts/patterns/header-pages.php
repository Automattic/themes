...
<figure class="wp-block-image size-full is-resized"><a href="/"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/excerpts_brand_black.png" alt="" class="wp-image-594" width="48"/></a></figure>
<!-- /wp:image -->
