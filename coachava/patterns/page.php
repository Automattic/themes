...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/non-existent-brand_1.png" alt="" class="" style="width:auto;height:72px"/></figure>
<!-- /wp:image -->

<!-- wp:image {"width":"auto","height":"72px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/non-existent-brand_2.png" alt="" class="" style="width:auto;height:72px"/></figure>
<!-- /wp:image -->

<!-- wp:image {"width":"auto","height":"72px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/non-existent-brand_3.png" alt="" class="" style="width:auto;height:72px"/></figure>
<!-- /wp:image -->

<!-- wp:image {"width":"auto","height":"72px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/non-existent-brand_4.png" alt="" class="" style="width:auto;height:72px"/></figure>
<!-- /wp:image -->
...
<!-- wp:image {"width":"auto","height":"72px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/non-existent-brand_5.png" alt="" class="" style="width:auto;height:72px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
