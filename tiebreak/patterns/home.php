...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/4_post_images.jpg" alt="" style="object-fit:cover;width:80px;height:70px"/></figure>
<!-- /wp:image -->
