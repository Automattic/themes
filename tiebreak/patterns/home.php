...
<h2 class="wp-block-heading has-text-align-left has-large-font-size" style="font-style:italic;font-weight:400"><?php esc_html_e('<em>Top Stories</em>', 'tiebreak');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/4_post_images-1024x723.jpg" alt="" class="" style="object-fit:cover;width:80px;height:70px"/></figure>
<!-- /wp:image -->
...
<h2 class="wp-block-heading has-text-align-center has-large-font-size" style="font-style:normal;font-weight:400"><?php esc_html_e('<em>Tennis Tournaments</em>', 'tiebreak');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading has-text-align-center has-large-font-size" style="font-style:normal;font-weight:400"><?php esc_html_e('<em>Categories</em>', 'tiebreak');?></h2>
<!-- /wp:heading -->

<!-- wp:columns {"align":"wide"} -->
<div class="wp-block-columns alignwide"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"\u003c?php echo esc_url( get_stylesheet_directory_uri() ); ?\u003e/assets/images/7_post_images.jpg","dimRatio":50,"isUserOverlayColor":true,"minHeight":260,"customGradient":"linear-gradient(360deg,rgb(0,0,0) 47%,rgba(253,253,253,0) 100%)","contentPosition":"bottom left","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}},"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60","right":"var:preset|spacing|60"}}},"textColor":"base"} -->
...
<p class="has-text-align-center has-medium-font-size"><?php esc_html_e('<a href="#"><em>Gear Reviews</em></a>', 'tiebreak');?></p>
...
<p class="has-text-align-center has-medium-font-size"><?php esc_html_e('<a href="#"><em>Tournaments</em></a>', 'tiebreak');?></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column -->
...
<p class="has-text-align-center has-medium-font-size"><?php esc_html_e('<a href="#"><em>History</em></a>', 'tiebreak');?></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column -->
...
<p class="has-text-align-center has-medium-font-size"><?php esc_html_e('<a href="#"><em>Fun Facts</em></a>', 'tiebreak');?></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
