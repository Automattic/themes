...
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('‹ Previous', 'handy');?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-right has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:700;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Next ›', 'handy');?></p>
<!-- /wp:paragraph -->
...
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Call us', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('Book via Phone Call', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('+(39) 1111-123456', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('Monday To Friday', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('09:00 To 6:00 PM', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontSize":"0.8rem","letterSpacing":"0.03rem","fontStyle":"normal","fontWeight":"600"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Address', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('785 15th St, Office 478', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e('Boston, MD 02130', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-secondary-color has-contrast-background-color has-text-color has-background has-link-color wp-element-button"><?php esc_html_e('Request a service', 'handy');?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
...
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:700;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Categories', 'handy');?></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}},"border":{"radius":"8px"}},"backgroundColor":"tertiary","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-tertiary-background-color has-background" style="border-radius:8px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontSize":"0.8rem","letterSpacing":"0.03rem","fontStyle":"normal","fontWeight":"700"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:700;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Latest posts', 'handy');?></p>
<!-- /wp:paragraph -->
