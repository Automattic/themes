...
<h1 class="wp-block-heading has-base-color has-text-color has-link-color"><?php esc_html_e('What can our professionals do for you?', 'handy');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p class="has-base-color has-text-color has-link-color"><?php esc_html_e('When you need service on your property, you need a trustworthy company to do the job right.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h3 class="wp-block-heading has-base-color has-text-color has-link-color" style="line-height:1.2"><?php esc_html_e('All types of home fixing', 'handy');?></h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70)"><!-- wp:group {"style":{"spacing":{"blockGap":"0.5rem"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<h3 class="wp-block-heading has-base-color has-text-color has-link-color" style="line-height:1.2"><?php esc_html_e('Professional renovation', 'handy');?></h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70)"><!-- wp:group {"style":{"spacing":{"blockGap":"0.5rem"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<h3 class="wp-block-heading has-base-color has-text-color has-link-color" style="line-height:1.2"><?php esc_html_e('Plumbing &amp; pipe repair', 'handy');?></h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70)"><!-- wp:group {"style":{"spacing":{"blockGap":"0.5rem"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<h3 class="wp-block-heading has-base-color has-text-color has-link-color" style="line-height:1.2"><?php esc_html_e('Electrical engineering', 'handy');?></h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h1 class="wp-block-heading"><?php esc_html_e('Reliable, Trusted, and Professional Handyman Services in New Jersey', 'handy');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:700;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Address', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:paragraph -->
<p><?php esc_html_e('123 Main Street', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Anytown, NJ', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e('07001 United States', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
...
<div class="wp-block-group" style="padding-right:2rem"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontSize":"0.8rem","letterSpacing":"0.03rem","fontStyle":"normal","fontWeight":"700"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:700;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Call us', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:paragraph -->
<p><?php esc_html_e('Book via Phone Call', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e('(555) 123-4567', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:25%"><!-- wp:group {"style":{"spacing":{"padding":{"right":"2rem"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group" style="padding-right:2rem"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontSize":"0.8rem","letterSpacing":"0.03rem","fontStyle":"normal","fontWeight":"700"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:700;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Opening hours', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:paragraph -->
<p><?php esc_html_e('Monday To Friday', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e('09:00 To 6:00 PM', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:25%"><!-- wp:group {"style":{"spacing":{"padding":{"right":"2rem"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group" style="padding-right:2rem"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontSize":"0.8rem","letterSpacing":"0.03rem","fontStyle":"normal","fontWeight":"700"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:700;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Follow us!', 'handy');?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left"><?php esc_html_e('Designed with WordPress.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->