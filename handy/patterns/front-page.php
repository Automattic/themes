...
<h1 class="wp-block-heading alignwide has-text-align-left"><?php esc_html_e('Transform Your Space with Our Expert Handyman Services', 'handy');?></h1>
<!-- /wp:heading -->
...
<p><?php esc_html_e('Discover top-notch home improvement, remodeling, and repair solutions tailored for you. Swift and reliable, we guarantee your service within 24 hours.', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e('Request a Service Now', 'handy');?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('WHAT we OFFER', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"75%"} -->
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e('We take pride in being certified experts committed to saving you time and money. Our approach ensures the most cost-effective solutions without compromising quality. We value responsibility and discretion, requiring no tools on your end.', 'handy');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/icon-handy_hfixing.png" alt="<?php esc_attr_e('', 'handy');?>" style="object-fit:cover;width:96px;height:96px"/></figure>
<!-- /wp:image -->

<!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"}}} -->
<h3 class="wp-block-heading" style="line-height:1.2"><?php esc_html_e('All types of home fixing', 'handy');?></h3>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/arrow-s.png" alt="<?php esc_attr_e('', 'handy');?>" style="border-style:none;border-width:0px;object-fit:cover;width:8px;height:8px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-column is-vertically-aligned-stretch"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|70"},"blockGap":"var:preset|spacing|50"},"border":{"radius":"8px"},"dimensions":{"minHeight":"100%"}},"backgroundColor":"tertiary","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"space-between"}} -->
<div class="wp-block-group has-tertiary-background-color has-background" style="border-radius:8px;min-height:100%;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:image {"width":"96px","height":"96px","scale":"cover","sizeSlug":"full","linkDestination":"custom","style":{"color":[]}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/icon-handy_renovation.png" alt="<?php esc_attr_e('', 'handy');?>" style="object-fit:cover;width:96px;height:96px"/></figure>
<!-- /wp:image -->

<!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"}}} -->
<h3 class="wp-block-heading" style="line-height:1.2"><?php esc_html_e('Professional renovation', 'handy');?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-column is-vertically-aligned-stretch"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|70"},"blockGap":"var:preset|spacing|50"},"border":{"radius":"8px"},"dimensions":{"minHeight":"100%"}},"backgroundColor":"tertiary","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"space-between"}} -->
<div class="wp-block-group has-tertiary-background-color has-background" style="border-radius:8px;min-height:100%;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:image {"width":"96px","height":"96px","scale":"cover","sizeSlug":"full","linkDestination":"custom","style":{"color":[]}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/icon-handy_plumbing.png" alt="<?php esc_attr_e('', 'handy');?>" style="object-fit:cover;width:96px;height:96px"/></figure>
<!-- /wp:image -->

<!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"}}} -->
<h3 class="wp-block-heading" style="line-height:1.2"><?php esc_html_e('Plumbing &amp; pipe repair', 'handy');?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-column is-vertically-aligned-stretch"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|70"},"blockGap":"var:preset|spacing|50"},"border":{"radius":"8px"},"dimensions":{"minHeight":"100%"}},"backgroundColor":"tertiary","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"space-between"}} -->
<div class="wp-block-group has-tertiary-background-color has-background" style="border-radius:8px;min-height:100%;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:image {"width":"96px","height":"96px","scale":"cover","sizeSlug":"full","linkDestination":"custom","style":{"color":[]}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/icon-handy_electrical.png" alt="<?php esc_attr_e('', 'handy');?>" style="object-fit:cover;width:96px;height:96px"/></figure>
<!-- /wp:image -->

<!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"}}} -->
<h3 class="wp-block-heading" style="line-height:1.2"><?php esc_html_e('Electrical engineering', 'handy');?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-columns alignwide"><!-- wp:column {"width":"25%"} -->
<div class="wp-block-column" style="flex-basis:25%"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontSize":"0.8rem","letterSpacing":"0.03rem","fontStyle":"normal","fontWeight":"600"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('How it works', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"75%"} -->
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading"><?php esc_html_e('We Follow Successful Processes and Get Your Work Done', 'handy');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h2 class="wp-block-heading has-text-align-center has-open-runde-font-family has-small-font-size" style="line-height:1"><?php esc_html_e('1', 'handy');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"}}} -->
<h3 class="wp-block-heading" style="line-height:1.2"><?php esc_html_e('Book Online', 'handy');?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('You share your needs with us and we will book a visit to the selected workplace.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"48px"},"dimensions":{"minHeight":"48px"},"border":{"radius":"50px"},"typography":{"lineHeight":"0"}},"backgroundColor":"secondary","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
<div class="wp-block-group has-secondary-background-color has-background" style="border-radius:50px;min-height:48px;line-height:0"><!-- wp:heading {"textAlign":"center","style":{"typography":{"lineHeight":"1"}},"fontSize":"small","fontFamily":"open-runde"} -->
<h2 class="wp-block-heading has-text-align-center has-open-runde-font-family has-small-font-size" style="line-height:1"><?php esc_html_e('2', 'handy');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"}}} -->
<h3 class="wp-block-heading" style="line-height:1.2"><?php esc_html_e('Phone Confirmation', 'handy');?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('We contact your for details on your project, and schedule an onsite estimate if necessary.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"48px"},"dimensions":{"minHeight":"48px"},"border":{"radius":"50px"},"typography":{"lineHeight":"0"}},"backgroundColor":"secondary","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
<div class="wp-block-group has-secondary-background-color has-background" style="border-radius:50px;min-height:48px;line-height:0"><!-- wp:heading {"textAlign":"center","style":{"typography":{"lineHeight":"1"}},"fontSize":"small","fontFamily":"open-runde"} -->
<h2 class="wp-block-heading has-text-align-center has-open-runde-font-family has-small-font-size" style="line-height:1"><?php esc_html_e('3', 'handy');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"}}} -->
<h3 class="wp-block-heading" style="line-height:1.2"><?php esc_html_e('Detail Estimate', 'handy');?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('We send you details and a cost estimate of your project needs.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"layout":{"selfStretch":"fixed","flexSize":"48px"},"dimensions":{"minHeight":"48px"},"border":{"radius":"50px"},"typography":{"lineHeight":"0"}},"backgroundColor":"secondary","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
<div class="wp-block-group has-secondary-background-color has-background" style="border-radius:50px;min-height:48px;line-height:0"><!-- wp:heading {"textAlign":"center","style":{"typography":{"lineHeight":"1"}},"fontSize":"small","fontFamily":"open-runde"} -->
<h2 class="wp-block-heading has-text-align-center has-open-runde-font-family has-small-font-size" style="line-height:1"><?php esc_html_e('4', 'handy');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.2"}}} -->
<h3 class="wp-block-heading" style="line-height:1.2"><?php esc_html_e('Task Completion', 'handy');?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Our team will do the assigned task while you relax and get your improvements done.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
...
<p class="has-secondary-color has-text-color has-link-color has-large-font-size"><?php esc_html_e('☛', 'handy');?></p>
<!-- /wp:paragraph -->
...
<p class="has-open-runde-font-family" style="font-style:normal;font-weight:600"><?php esc_html_e('Trustworthy and reliable team members', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"layout":{"selfStretch":"fill","flexSize":null},"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-style:normal;font-weight:600"><?php esc_html_e('24/7 Professional Services', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"layout":{"selfStretch":"fill","flexSize":null},"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-style:normal;font-weight:600"><?php esc_html_e('Responsibility with Affordable Prices', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/workers_blue-yellow.jpg" alt="<?php esc_attr_e('', 'handy');?>" style="aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Blog', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading"><?php esc_html_e('Our Latest News', 'handy');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:columns {"verticalAlignment":"top","align":"wide"} -->
<div class="wp-block-columns alignwide are-vertically-aligned-top"><!-- wp:column {"verticalAlignment":"top","width":""} -->
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:query {"queryId":0,"query":{"perPage":"1","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[]},"tagName":"main","enhancedPagination":true,"align":"wide","layout":{"type":"constrained"}} -->
<main class="wp-block-query alignwide"><!-- wp:post-template {"align":"wide","layout":{"type":"grid","columnCount":1}} -->
...
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:spacer {"height":"6.5vh"} -->
<div style="height:6.5vh" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->

<!-- wp:query {"queryId":0,"query":{"perPage":"1","pages":0,"offset":"1","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[]},"tagName":"main","enhancedPagination":true,"align":"wide","layout":{"type":"constrained"}} -->
<main class="wp-block-query alignwide"><!-- wp:post-template {"align":"wide","layout":{"type":"grid","columnCount":1}} -->
<!-- wp:group {"style":{"spacing":{"blockGap":"1rem"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:post-featured-image {"isLink":true,"aspectRatio":"4/3"} /-->
...
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:700;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('More about us', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading"><?php esc_html_e('Frequently Asked Questions', 'handy');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p class="has-small-font-size" style="font-style:normal;font-weight:400"><?php esc_html_e('Yes, absolutely! Our commitment is to get back to you promptly within 24-48 hours from the time of your inquiry. Your time is valuable, and we strive to provide swift and efficient communication.', 'handy');?></p>
...
<p class="has-small-font-size" style="font-style:normal;font-weight:400"><?php esc_html_e('Certainly! We believe in empowering our customers with options. You can expect to receive multiple estimates, each outlining different approaches and costs for your project. This way, you have the flexibility to choose the solution that best aligns with your preferences and budget.', 'handy');?></p>
<!-- /wp:paragraph --></details>
<!-- /wp:details --></div>
<!-- /wp:group -->
...
<p class="has-small-font-size" style="font-style:normal;font-weight:400"><?php esc_html_e('Absolutely! We take pride in the quality of our work, and all our repairs come with a solid guarantee. If you encounter any issues post-service, simply reach out to our customer support, and we\'ll address it promptly. Your satisfaction and the longevity of our work are our top priorities.', 'handy');?></p>
<!-- /wp:paragraph --></details>
<!-- /wp:details --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-group alignwide"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontSize":"0.8rem","letterSpacing":"0.03rem","fontStyle":"normal","fontWeight":"600"}},"fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Testimonials', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading"><?php esc_html_e('Our Customers Say', 'handy');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/speech-marks.png" alt="<?php esc_attr_e('', 'handy');?>" style="aspect-ratio:1;object-fit:cover;width:24px"/></figure>
<!-- /wp:image -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Working with Handy has been a game-changer for my real estate business. Their swift response and impeccable handyman services have made property preparation a breeze. I can confidently recommend Handy to my clients, knowing that their expertise adds significant value to any home improvement project.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Working-Class-Woman-Profile.jpg" alt="<?php esc_attr_e('', 'handy');?>" style="object-fit:cover;width:80px;height:80px"/></figure>
<!-- /wp:image -->
...
<p class="has-open-runde-font-family has-small-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e('Bernadette Porter', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small","fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family has-small-font-size"><?php esc_html_e('Real State Agent', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:paragraph -->
<p><?php esc_html_e('As a homemaker, finding a reliable handyperson service was crucial for the upkeep of our home. Handy exceeded my expectations with their skilled, respectful, and efficient team. From minor fixes to major renovations, they become my go-to partner for all home improvement. I couldn\'t be happier with the results.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"80px","height":"80px","scale":"cover","sizeSlug":"full","linkDestination":"none","className":"is-style-rounded","style":{"color":{"duotone":"unset"}}} -->
<figure class="wp-block-image size-full is-resized is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Social-Media-Profile-Photo-55-Year-Old-Woman.jpg" alt="<?php esc_attr_e('', 'handy');?>" style="object-fit:cover;width:80px;height:80px"/></figure>
<!-- /wp:image -->

<!-- wp:group {"style":{"spacing":{"blockGap":"0rem"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"small","fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family has-small-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e('Melissa Vera', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"small","fontFamily":"open-runde"} -->
<p class="has-open-runde-font-family has-small-font-size"><?php esc_html_e('Homemaker', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
