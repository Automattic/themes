...
<p class="has-base-color has-text-color has-link-color has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Book an appointment', 'handy');?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
<h1 class="wp-block-heading has-base-color has-text-color has-link-color"><?php esc_html_e('Request a Service', 'handy');?></h1>
<!-- /wp:heading -->
...
<p class="has-base-color has-text-color has-link-color" style="font-style:normal;font-weight:500"><?php esc_html_e('If you have any questions, please don\'t hesitate to contact us.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:jetpack/contact-form {"subject":"[handy] Front Page","className":"is-style-animated"} -->
...
<p class="has-open-runde-font-family" style="font-size:0.8rem;font-style:normal;font-weight:600;letter-spacing:0.03rem;text-transform:uppercase"><?php esc_html_e('Follow us!', 'handy');?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-small-font-size"><?php esc_html_e('Designed with WordPress.', 'handy');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
