...
<div class="wp-block-group" style="margin-top:0vh;margin-bottom:0vh"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"bottom":"2px"}},"border":{"bottom":{"width":"2px"},"top":[],"right":[],"left":[]}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group alignwide"><!-- wp:heading {"textAlign":"left","level":1,"align":"wide","style":{"typography":{"fontSize":"4rem"}}} -->
<h1 class="wp-block-heading alignwide has-text-align-left" style="font-size:4rem"><?php esc_html_e('We\'re sorry!', 'specials');?></h1>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"left","level":1,"align":"wide","style":{"typography":{"fontSize":"4rem"}}} -->
<h1 class="wp-block-heading alignwide has-text-align-left" style="font-size:4rem"><?php esc_html_e('Nothing has last...', 'specials');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p><?php esc_html_e('We are apparently out of that item, or the page you are looking for doesn\'t exist. What do you think about a new selection? Try a search.', 'specials');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
