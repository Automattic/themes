...
<!-- wp:group {"tagName":"main","metadata":{"name":"Content"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"color":{"gradient":"linear-gradient(180deg,rgb(7,202,255) 0%,rgb(203,254,1) 10%)"},"dimensions":{"minHeight":"50vh"}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group has-background" style="background:linear-gradient(180deg,rgb(7,202,255) 0%,rgb(203,254,1) 10%);min-height:50vh;margin-top:0;margin-bottom:0"><!-- wp:group {"metadata":{"name":"Contrast Color Wrapper"},"align":"wide","style":{"border":{"left":{"width":"1px"},"right":{"width":"1px"}},"spacing":{"padding":{"right":"4px","left":"4px"}},"dimensions":{"minHeight":"50vh"}},"backgroundColor":"primary","layout":{"type":"constrained"}} -->
