...
/**
 * Title: search
 * Slug: psychedeli/search
 * Inserter: no
 */
?>
<!-- wp:template-part {"slug":"header","tagName":"header"} /-->

<!-- wp:group {"tagName":"main","metadata":{"name":"Content"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"color":{"gradient":"linear-gradient(180deg,rgb(7,202,255) 0%,rgb(203,254,1) 10%)"}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group has-background" style="background:linear-gradient(180deg,rgb(7,202,255) 0%,rgb(203,254,1) 10%);margin-top:0;margin-bottom:0"><!-- wp:group {"metadata":{"name":"Contrast Color Wrapper"},"align":"wide","style":{"border":{"left":{"width":"1px"},"right":{"width":"1px"}},"spacing":{"padding":{"right":"4px","left":"4px"}}},"backgroundColor":"primary","layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide has-base-background-color has-background" style="border-right-width:1px;border-left-width:1px;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--60)"><!-- wp:search {"showLabel":false,"width":100,"widthUnit":"%","buttonPosition":"button-inside","buttonUseIcon":true} /-->

<!-- wp:query {"queryId":14,"query":{"perPage":10,"pages":0,"offset":"3","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"align":"wide"} -->
<div class="wp-block-query alignwide"><!-- wp:query-title {"type":"search","textAlign":"center"} /-->
...
<div class="wp-block-cover is-light" style="min-height:100%"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:post-featured-image {"isLink":true,"aspectRatio":"1","width":"220px","height":"220px","style":{"color":[],"border":{"radius":"200px"}}} /--></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column -->
