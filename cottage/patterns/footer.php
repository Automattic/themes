...
<p class="has-league-spartan-font-family has-x-small-font-size" style="font-style:normal;font-weight:400;letter-spacing:0.1em;text-transform:uppercase"><?php esc_html_e('Designed with <a href="https://wordpress.org" rel="nofollow">WordPress</a>', 'cottage');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->