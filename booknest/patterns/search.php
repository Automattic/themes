...
<!-- wp:group {"tagName":"main","lock":{"move":false,"remove":true},"metadata":{"name":"Content Wrapper"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}},"dimensions":{"minHeight":"85vh"}}} -->
...
<main class="wp-block-query alignwide"><!-- wp:query-title {"type":"search","textAlign":"center","level":2,"showSearchTerm":false} /-->

<!-- wp:group {"metadata":{"name":"Search Block"},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:search {"showLabel":false,"buttonText":"Search"} /-->
