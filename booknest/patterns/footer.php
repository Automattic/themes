...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":1,"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}},"layout":{"selfStretch":"fill","flexSize":null},"typography":{"letterSpacing":"0.025rem","textTransform":"uppercase"}},"textColor":"base","fontSize":"xx-large"} -->
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color has-link-color has-xx-large-font-size" style="letter-spacing:0.025rem;text-transform:uppercase"><?php esc_html_e('Join the club', 'booknest');?></h1>
<!-- /wp:heading -->
