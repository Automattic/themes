...
<h2 class="wp-block-heading alignwide has-secondary-color has-text-color has-link-color has-medium-font-size"><?php esc_html_e('&lt;em&gt;Chef&lt;/em&gt; de Cuisine', 'dossier');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
