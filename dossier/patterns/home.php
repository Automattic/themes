...
<div class="wp-block-column"><!-- wp:heading {"level":1,"align":"wide","className":"no-underline","style":{"typography":{"textTransform":"uppercase"}},"fontSize":"x-large"} -->
<h1 class="wp-block-heading alignwide no-underline has-x-large-font-size" style="text-transform:uppercase"><?php esc_html_e('Blog', 'dossier');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
