...
<h1 class="wp-block-heading has-text-align-left" style="font-size:7rem;font-style:normal;font-weight:100;letter-spacing:-0.07em;line-height:1">Awaken your <em>potential</em></h1>
<!-- /wp:heading -->
...
<p class="has-text-align-left">Join us in the city’s most beautiful and friendly yoga studio, where the most talented teachers are ready to help you discover, explore and develop your yoga practice.</p>
<!-- /wp:paragraph -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":18,"sizeSlug":"full","linkDestination":"none","align":"wide","style":{"border":{"radius":{"topLeft":"400px"}}},"className":"is-style-default"} -->
<figure class="wp-block-image alignwide size-full has-custom-border is-style-default"><img src="https://yogabusiness.mystagingwebsite.com/wp-content/themes/kamala/assets/images/hero_image-scaled.jpg" alt="" class="wp-image-18" style="border-top-left-radius:400px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
