...
<h1 class="wp-block-heading alignwide has-text-align-left"><?php echo esc_html__( 'We\'re sorry!', 'my-menu' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"left","level":1,"align":"wide","anchor":"oops-that-page-can-t-be-found"} -->
<h1 class="wp-block-heading alignwide has-text-align-left"><?php echo esc_html__( 'Nothing has last...', 'my-menu' ); ?></h1>
<!-- /wp:heading -->
...
<p><?php echo esc_html__( 'We are apparently out of that item. What about a new selection?', 'my-menu' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group alignfull"><!-- wp:search {"showLabel":false,"width":100,"widthUnit":"%","buttonText":"<?php echo esc_html__( 'Search', 'my-menu' ); ?>"} /-->
