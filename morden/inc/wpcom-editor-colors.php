...
add_editor_color_rule( 'bg', '#FFFFFF', array(
	...
	// Background-color
	array( '#editor .editor-styles-wrapper .fse-template-part #toggle-menu.has-background-color,
	...
	array( '.button,
			...
			.fse-template-part .main-navigation a:link,
			.fse-template-part .main-navigation a:visited,
...
add_editor_color_rule( 'link', '#CD2220', array(
	...
	array( '#editor .editor-styles-wrapper .wp-block-button.is-style-outline .wp-block-button__link:not(.has-text-color),
			#editor .editor-styles-wrapper .wp-block-button.is-style-outline .wp-block-button__link.is-style-outline:not(.has-text-color),
...
add_editor_color_rule( 'txt', '#303030', array(
	...
	array( '#editor .editor-styles-wrapper .editor-post-title__block .editor-post-title__input,
			#editor .editor-styles-wrapper .fse-template-part #toggle-menu.has-background-color,
...
add_editor_color_rule( 'fg1', '#007AB7', array(
