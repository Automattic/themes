<?php
/**
 * Newsletter signup with fixed background image
 */
return array(
	'title'      => __( 'Newsletter signup with fixed background image', 'lettre' ),
	'categories' => array( 'featured', 'newsletter' ),
	'content'    => '<!-- wp:cover {"url":"' . esc_url( get_template_directory_uri() ) . '/assets/images/book.jpg","hasParallax":true,"dimRatio":30,"overlayColor":"secondary","minHeight":100,"minHeightUnit":"vh","isDark":false,"align":"full","style":{"spacing":{"padding":{"top":"120px","right":"120px","bottom":"120px","left":"120px"}}}} -->
					...
					<p class="has-text-align-center has-text-color has-xx-large-font-size" style="color:#df0522;line-height:1">' . esc_html__( 'You don’t wanna miss it.', 'lettre' ) . '</p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"align":"center","style":{"color":{"text":"#f30800"}}} -->
					<p class="has-text-align-center has-text-color" style="color:#f30800">' . esc_html__( 'Get the latest articles in your inbox.', 'lettre' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group -->
