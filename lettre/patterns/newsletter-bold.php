...
<p class="has-text-align-left has-foreground-color has-text-color" style="font-size:max(48px, 10vw);line-height:1"><strong><?php esc_html__( 'Sign up for updates', 'lettre' ); ?></strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:jetpack/subscriptions {"subscribePlaceholder":"<?php esc_html__( 'Email Address', 'lettre' ); ?>","buttonOnNewLine":true,"buttonWidth":"100%","submitButtonText":"<?php esc_html__( 'Subscribe', 'lettre' ); ?>","buttonBackgroundColor":"foreground","textColor":"secondary","fontSize":"50px","customFontSize":"50px","borderRadius":0,"borderWeight":8,"borderColor":"foreground","padding":40,"spacing":40,"className":"is-style-split"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
