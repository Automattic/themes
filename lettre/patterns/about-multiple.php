 ...
 */
return array(
	'title'      => __( 'About the authors', 'lettre' ),
	'categories' => array( 'featured', 'about' ),
	'content'    => '<!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":"60px"}}} -->
					...
					<div class="wp-block-columns alignwide"><!-- wp:column {"width":"100px"} -->
					<div class="wp-block-column" style="flex-basis:100px"><!-- wp:image {"sizeSlug":"full","linkDestination":"none","className":"is-style-rounded"} -->
					<figure class="wp-block-image size-full is-style-rounded"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/blue-square.png" alt="' . esc_attr__( 'A generic profile picture.', 'lettre' ) . '"/></figure>
					<!-- /wp:image --></div>
					<!-- /wp:column -->

					<!-- wp:column -->
					<div class="wp-block-column"><!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"0px","top":"0px"}}},"fontSize":"large"} -->
					<h2 class="has-large-font-size" style="margin-top:0px;margin-bottom:0px">' . esc_html__( 'Jennifer Rosa', 'lettre' ) . '</h2>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"fontSize":"small"} -->
					<p class="has-small-font-size">' . esc_html__( 'I’m an author and illustrator with a love for clasics. You’ll usually find me at a coffee shop, with my nose in a book.', 'lettre' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns --></div>
					<!-- /wp:column --></div>
