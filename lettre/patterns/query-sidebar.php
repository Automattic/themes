<?php
/**
 * List of posts with sidebar
 */
return array(
	'title'      => __( 'List of posts with sidebar', 'lettre' ),
	'categories' => array( 'columns', 'featured', 'query' ),
	'content'    => '<!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":"60px"}}} -->
					<div class="wp-block-columns alignwide"><!-- wp:column {"width":"70%"} -->
					<div class="wp-block-column" style="flex-basis:70%"><!-- wp:query {"queryId":7,"query":{"pages":0,"offset":"0","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"perPage":"5"},"displayLayout":{"type":"list"}} -->
...
<!-- /wp:separator --></div>
					...
					<p class="has-small-font-size" style="text-transform:uppercase">' . esc_html__( 'About Manuel', 'lettre' ) . '</p>
					<!-- /wp:paragraph -->
