<?php
/**
 * Newsletter intro with dark background image.
 */
return array(
	'title'      => __( 'Newsletter intro with dark background image', 'lettre' ),
	'categories' => array( 'featured', 'newsletter' ),
	'content'    => '<!-- wp:cover {"url":"' . esc_url( get_template_directory_uri() ) . '/assets/images/envelopes.jpg","id":129,"dimRatio":70,"overlayColor":"foreground","minHeight":90,"minHeightUnit":"vh","align":"full"} -->
					<div class="wp-block-cover alignfull" style="min-height:90vh"><span aria-hidden="true" class="wp-block-cover__background has-foreground-background-color has-background-dim-70 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-129" alt="' . esc_attr__( 'A photograph of vintage envelopes.', 'lettre' ) . '" src="' . esc_url( get_template_directory_uri() ) . '/assets/images/envelopes.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"textColor":"secondary","className":"has-secondary-color has-text-color has-link-color","layout":{"wideSize":"360px"}} -->
