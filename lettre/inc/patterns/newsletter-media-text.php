<?php
/**
 * Newsletter signup with media on the left
 */
return array(
	'title'      => __( 'Newsletter signup with media on the left', 'lettre' ),
	'categories' => array( 'featured', 'newsletter' ),
	'content'    => '<!-- wp:media-text {"align":"full","mediaType":"image","mediaWidth":42,"verticalAlignment":"center","style":{"color":{"background":"#ffe030"}}} -->
					<div class="wp-block-media-text alignfull is-stacked-on-mobile is-vertically-aligned-center has-background" style="background-color:#ffe030;grid-template-columns:42% auto"><figure class="wp-block-media-text__media"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/flowers-vase.jpg" alt="Illustration of flowers in a vase."/></figure><div class="wp-block-media-text__content"><!-- wp:group {"style":{"spacing":{"blockGap":"0px"}}} -->
					<div class="wp-block-group"><!-- wp:spacer {"height":"60px"} -->
					<div style="height:60px" aria-hidden="true" class="wp-block-spacer"></div>
					<!-- /wp:spacer -->

					<!-- wp:paragraph {"textColor":"black","fontSize":"large"} -->
					<p class="has-black-color has-text-color has-large-font-size">' . esc_html__( 'Subscribe to our newsletter to get the latest stories in your inbox.', 'lettre' ) . '</p>
					<!-- /wp:paragraph -->
