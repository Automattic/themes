 ...
 */
return array(
	'title'      => __( 'List of posts', 'lettre' ),
	'categories' => array( 'featured', 'query' ),
	'content'    => '<!-- wp:query {"queryId":37,"query":{"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"perPage":3},"displayLayout":{"type":"list"},"align":"wide"} -->
