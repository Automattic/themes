...
<main class="wp-block-group alignwide"><!-- wp:group {"metadata":{"name":"Search"},"align":"wide","layout":{"type":"default"}} -->
...
<!-- wp:query {"queryId":14,"query":{"perPage":"8","pages":"0","offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false,"parents":[]},"enhancedPagination":true,"align":"wide","layout":{"type":"constrained"}} -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0.5rem","margin":{"bottom":"var:preset|spacing|40"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
