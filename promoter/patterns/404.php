...
<h1 class="wp-block-heading alignwide has-text-align-left has-libre-baskerville-font-family" id="oops-that-page-can-t-be-found" style="font-size:3rem;letter-spacing:-0.02rem;line-height:1.2"><?php echo esc_html__( 'Oops!', 'promoter' ); ?><br><?php echo esc_html__( 'That page can’t be found.', 'promoter' ); ?></h1>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'It looks like nothing was found at this location. Maybe try a search?', 'promoter' ); ?></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h1 class="wp-block-heading alignwide" style="font-size:0.9rem;font-style:normal;font-weight:400;letter-spacing:-0.02rem;line-height:1.1;text-transform:uppercase"><?php echo esc_html__( 'Search', 'promoter' ); ?></h1>
<!-- /wp:heading -->
