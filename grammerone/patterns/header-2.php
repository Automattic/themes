...
<figure class="wp-block-image size-full is-resized has-custom-border is-style-default"><a href="/"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/hand-light-photography-photographer-green-lens-595221-pxhere.com_-1.jpg" alt="" class="has-border-color wp-image-1221" style="border-color:#222329;border-width:1px;border-radius:4px;width:80px;height:80px" width="80" height="80"/></a></figure>
<!-- /wp:image -->
