...
<div class="wp-block-column" style="flex-basis:33.3%"><!-- wp:paragraph {"align":"left","placeholder":"Write title…"} -->
<p class="has-text-align-left"><?php esc_html_e('The ultimate guide to the world of indoor plants! Explore the wonders of plants in our lives, lifestyles, and well-being. Welcome to the world of our green treasures.', 'casthub');?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"metadata":{"name":"Subscribe"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|70"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:var(--wp--preset--spacing--70)"><!-- wp:paragraph {"align":"left","placeholder":"Write title…","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.05rem","fontStyle":"normal","fontWeight":"700"}},"fontSize":"x-small"} -->
<p class="has-text-align-left has-x-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:0.05rem;text-transform:uppercase"><?php esc_html_e('Subscribe', 'casthub');?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"metadata":{"name":"Links for Players"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"24px","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|secondary"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icon_pocketcasts.png" alt="" style="width:24px"/></figure>
<!-- /wp:image -->

<!-- wp:image {"width":"24px","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|secondary"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icon_apple.png" alt="" style="width:24px"/></figure>
<!-- /wp:image -->

<!-- wp:image {"width":"24px","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|secondary"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icon_spotify.png" alt="" style="width:24px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
...
<!-- wp:group {"metadata":{"name":"Color detail"},"align":"wide","style":{"dimensions":{"minHeight":"3rem"},"spacing":{"padding":{"right":"0","left":"0"}}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide has-base-background-color has-background" style="min-height:3rem;padding-right:0;padding-left:0"></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->