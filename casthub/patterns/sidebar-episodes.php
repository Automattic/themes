<?php
/**
 * Title: sidebar-episodes
 * Slug: casthub/sidebar-episodes
 * Inserter: no
 */
?>
<!-- wp:group {"metadata":{"name":"Sidebar wrapper"},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:group {"metadata":{"name":"About the Host"},"style":{"spacing":{"blockGap":"var:preset|spacing|60"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
...
<p class="has-x-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:0.025rem;text-transform:uppercase"><?php esc_html_e('About the host', 'casthub');?></p>
<!-- /wp:paragraph -->
...
<p><?php esc_html_e('Meet Gwyneth Bush, your spirited host and passionate plant enthusiast, who is ready to take you on an enthralling journey into the captivating world of houseplants.', 'casthub');?></p>
<!-- /wp:paragraph -->
...
echo sprintf( esc_html__( '%1$sAbout Gwyneth Bush%2$s', 'casthub' ), '<a href="' . esc_url( '#' ) . '">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"700","letterSpacing":"0.025rem"}},"fontSize":"x-small"} -->
<p class="has-x-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:0.025rem;text-transform:uppercase"><?php esc_html_e('Latest episodes', 'casthub');?></p>
<!-- /wp:paragraph -->
