...
<h1 class="wp-block-heading has-text-align-left has-x-large-font-size"><?php echo esc_html__( 'There\'s nothing here.', 'rothko' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'The page you\'re looking for doesn\'t seem to exist.', 'rothko' ); ?></p>
<!-- /wp:paragraph -->
