...
/**
 * Title: A 404 page
 * Slug: titleless/hidden-about-content
 * Inserter: no
 */
...
<h3 class="wp-block-heading" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><?php echo esc_html__( 'About the author', 'titleless' ); ?></h3>
<!-- /wp:heading -->
