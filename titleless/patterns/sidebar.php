...
<h3 class="wp-block-heading"><?php esc_html_e('Related Articles', 'titleless');?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading"><?php esc_html_e('Get updates', 'titleless');?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Spam-free subscription, we guarantee. This is just a friendly ping when new content is out.', 'titleless');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
