...
<div class="wp-block-group" style="padding-right:0px;padding-left:40px"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/shawburn23_cover.png","id":12,"dimRatio":0,"isDark":false,"align":"wide","style":{"spacing":{"padding":{"left":"0px"}}},"layout":{"type":"constrained"}} -->
...
<!-- wp:paragraph -->
<p>At Shawburn23 we deliver outstanding results across 3 key business areas: branding, web design, and digital marketing.</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/logo_1-1.png" alt="" class="wp-image-73"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":74,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/logo_2-1.png" alt="" class="wp-image-74"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":75,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/logo_3-1.png" alt="" class="wp-image-75"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/shawburn23_image_2.png" alt="" class="wp-image-38"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<p style="font-size:1.6rem;line-height:1.3">“Shawburn23 took care of our online marketing with some amazing results. We are now the first result in every search engine.”</p>
<!-- /wp:paragraph -->
