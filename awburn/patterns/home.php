...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/awburn_image_2.png" alt="" class="wp-image-38"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
