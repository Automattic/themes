<?php
/**
 * Title: Search and browse by category
 * Slug: bain-marie/search-browse-category
 * Categories: featured
 * Inserter: yes
 */
...
<!-- wp:heading {"textAlign":"center","align":"wide","style":{"typography":{"fontStyle":"italic","fontWeight":"200"}},"fontSize":"x-large"} -->
<h2 class="wp-block-heading alignwide has-text-align-center has-x-large-font-size" style="font-style:italic;font-weight:200"><em><?php esc_html_e('Tasty food, made simple, for everyone.', 'bain-marie');?></em>.</h2>
<!-- /wp:heading -->
