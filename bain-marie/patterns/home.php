...
/**
 * Title: home
 * Slug: bain-marie/home
 * Categories: hidden
 * Inserter: no
 */
?>

<!-- wp:cover {"overlayColor":"tertiary","isUserOverlayColor":true,"isDark":false,"metadata":{"name":"Search field and browse by category"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-light" style="margin-top:0;margin-bottom:0"><span aria-hidden="true" class="wp-block-cover__background has-tertiary-background-color has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:spacer {"height":"50px"} -->
...
<!-- wp:heading {"textAlign":"left","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.16em"}},"fontSize":"small","fontFamily":"jost"} -->
<h2 class="wp-block-heading has-text-align-left has-jost-font-family has-small-font-size" style="letter-spacing:0.16em;text-transform:uppercase"><a href="#"><?php esc_html_e('Salads', 'bain-marie');?>Salads</a></h2>
<!-- /wp:heading -->
