 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Homepage with featured post, search section and post list"},"align":"full","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignfull"><!-- wp:group {"metadata":{"name":"Sticky Header"},"align":"full","style":{"position":{"type":"sticky","top":"0px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull"><!-- wp:template-part {"slug":"header","theme":"bain-marie","tagName":"header","align":"full"} /--></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading has-text-align-center has-base-color has-text-color has-link-color">Search recipes</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base","fontSize":"small"} -->
<p class="has-text-align-center has-base-color has-text-color has-link-color has-small-font-size">Or browse <em><a href="#">all recipes</a></em></p>
<!-- /wp:paragraph -->
...
<!-- wp:template-part {"slug":"footer","theme":"bain-marie","tagName":"footer"} /--></div>
<!-- /wp:group -->