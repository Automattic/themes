...
<h2 class="wp-block-heading alignwide">What We Do</h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading">Why You'll Love Us</h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"66.6%"} -->
<div class="wp-block-column" style="flex-basis:66.6%"><!-- wp:paragraph -->
<p>Organic farming is a form of food production that emphasizes the use of natural methods to maintain soil fertility, control pests, and produce high-quality crops without the use of synthetic pesticides and fertilizers.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>It's a practice based on biodiversity, ecological balance, and sustainability. It is environmentally sustainable, promotes soil health and biodiversity, reduces the negative impacts of agriculture on the environment, and produces safe, and healthy food. With the growing demand for organic food, there has never been a better time to choose organic.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;text-transform:uppercase">Our organic farm in numbers</h3>
<!-- /wp:heading -->
...
<p class="has-rubik-font-family" style="font-size:1.4rem;font-style:normal;font-weight:400;letter-spacing:5%;line-height:1.4">100%</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<p class="has-rubik-font-family" style="font-size:1.4rem;font-style:normal;font-weight:300;letter-spacing:5%;line-height:1.4">satisfied customers</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:column {"width":""} -->
<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"fontSize":"1.4rem","lineHeight":"1.4","fontStyle":"normal","fontWeight":"300","letterSpacing":"5%"},"layout":{"selfStretch":"fixed","flexSize":"64px"}},"fontFamily":"rubik"} -->
<p class="has-rubik-font-family" style="font-size:1.4rem;font-style:normal;font-weight:300;letter-spacing:5%;line-height:1.4">households per month</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:column {"width":""} -->
<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"fontSize":"1.4rem","lineHeight":"1.4","fontStyle":"normal","fontWeight":"300","letterSpacing":"5%"},"layout":{"selfStretch":"fixed","flexSize":"64px"}},"fontFamily":"rubik"} -->
<p class="has-rubik-font-family" style="font-size:1.4rem;font-style:normal;font-weight:300;letter-spacing:5%;line-height:1.4">awards won</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:column {"width":""} -->
<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"fontSize":"1.4rem","lineHeight":"1.4","fontStyle":"normal","fontWeight":"300","letterSpacing":"5%"},"layout":{"selfStretch":"fixed","flexSize":"64px"}},"fontFamily":"rubik"} -->
<p class="has-rubik-font-family" style="font-size:1.4rem;font-style:normal;font-weight:300;letter-spacing:5%;line-height:1.4">experts working</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-column" style="flex-basis:66.6%"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/barnsbury_the-farm.png","id":463,"dimRatio":0,"minHeight":520,"minHeightUnit":"px"} -->
<div class="wp-block-cover" style="min-height:520px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-463" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/barnsbury_the-farm.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
...
<h3 class="wp-block-heading" style="text-transform:uppercase">Our Favourite Recipes</h3>
<!-- /wp:heading -->
...
<div class="wp-block-button has-custom-font-size has-rubik-font-family" style="font-size:0.9rem;letter-spacing:5%;text-transform:uppercase"><a class="wp-block-button__link has-border-color has-tertiary-border-color wp-element-button" style="border-width:2px;padding-top:16px;padding-right:24px;padding-bottom:16px;padding-left:24px">More recipes</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
