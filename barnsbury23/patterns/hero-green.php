...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/b-original_hero.jpg","id":621,"dimRatio":0,"minHeight":520,"style":{"color":[]}} -->
