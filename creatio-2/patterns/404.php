...
<?php echo esc_html_x( 'Oops! That page can’t be found.', 'creatio-2' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html_x( 'It looks like nothing was found at this location. Maybe try a search?', 'creatio-2' ); ?></p>
<!-- /wp:paragraph -->
