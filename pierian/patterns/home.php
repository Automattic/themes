...
<div class="wp-block-column is-vertically-aligned-stretch has-background-background-color has-background" style="border-left-width:1px;padding-top:0rem;padding-right:var(--wp--preset--spacing--50);padding-bottom:0rem;padding-left:var(--wp--preset--spacing--50);flex-basis:20%">
<!-- wp:template-part {"slug":"sidebar-left","area":"sidebar"} /-->
</div>
<!-- /wp:column -->
