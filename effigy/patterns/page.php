...
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--70)"><!-- wp:template-part {"slug":"header-pages","theme":"effigy"} /-->
...
<!-- wp:template-part {"slug":"post-meta","theme":"effigy"} /--></main>
<!-- /wp:group -->
