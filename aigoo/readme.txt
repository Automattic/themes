...
Aigoo is a theme for K-Pop enthusiasts. This WordPress blogging block theme features a variety of query loop patterns and a sidebar making it perfect for any other topic.

== Changelog ==

= 1.0.2 =
* Aigoo: Remove a stray greater than on the homepage template (#8275)
