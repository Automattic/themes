...
<p class="has-libre-caslon-text-font-family" style="font-size:1.2rem;line-height:1.6"><a href="https://ritratto.mystagingwebsite.com/about/" data-type="page" data-id="2">Ernest M. Hemingway was an American novelist, short-story writer, journalist, and sportsman.</a></p>
<!-- /wp:paragraph -->

<!-- wp:image {"id":220,"width":96,"height":96,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/cropped-ritratto_image-author.jpg" alt="" class="wp-image-220" width="96" height="96"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
