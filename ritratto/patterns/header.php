...
<h1 class="wp-block-heading alignwide has-base-color has-text-color has-link-color has-instrument-serif-font-family" style="font-size:8rem;font-style:normal;font-weight:400;letter-spacing:-0.2rem;line-height:1"><a href="/">Hemingway</a></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:navigation {"ref":456,"overlayMenu":"never","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"right","orientation":"horizontal"},"style":{"spacing":{"margin":{"top":"0"}},"typography":{"lineHeight":"1"}}} /-->
