...
<h1 class="wp-block-heading has-text-align-left has-primary-color has-text-color has-link-color has-figtree-font-family has-small-font-size" style="line-height:1.4;text-transform:uppercase"><?php esc_html_e('Save<br>the<br>Date', 'vows');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<p class="has-text-align-left has-small-font-size"><?php esc_html_e('September 15, 2024 — 4:00 PM<br>Whispering Pines Resort, Lake Tahoe, CA<br>Reception to follow ceremony', 'vows');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
