...
<!-- wp:image {"id":341,"width":48,"sizeSlug":"full","linkDestination":"custom"} -->
<figure class="wp-block-image size-full is-resized"><a href="https://theissue.mystagingwebsite.com/"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/theissue_brand-b.png" alt="" class="wp-image-341" width="48"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
