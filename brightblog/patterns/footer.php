...
<h2 class="wp-block-heading has-x-large-font-size"><?php echo __('Tumblr', 'brightblog');?></h2>
<!-- /wp:heading -->

<!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="wp-block-heading has-x-large-font-size"><?php echo __('Instagram', 'brightblog');?></h2>
<!-- /wp:heading -->

<!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="wp-block-heading has-x-large-font-size"><?php echo __('Facebook', 'brightblog');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"align":"left"} -->
<p class="has-text-align-left"><?php echo __('Designed with <a rel="nofollow" href="https://wordpress.org">WordPress</a>', 'brightblog');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
