...
return array(
	...
	<p style="font-size:clamp(64px, 6vw, 100px);font-style:normal;font-weight:100;line-height:1;text-transform:uppercase">' . wp_kses_post( __( 'Palace of <br>the Circus at <br>Chichen-Itza, <br>bas-relief of <br>tigers', 'archeo' ) ) . '</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:column -->
