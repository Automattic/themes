...
return array(
	...
	<!-- wp:column -->
	<div class="wp-block-column"><!-- wp:spacer {"height":"min(35rem, 34vw)"} -->
	<div style="height:min(35rem, 34vw)" aria-hidden="true" class="wp-block-spacer"></div>
	<!-- /wp:spacer -->
	
	<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}}} -->
	<p style="line-height:1.5">' . __( 'Uxmal is an ancient Maya city located in present-day Mexico. It is considered one of the most important archaeological sites of Maya culture.', 'archeo' ) . '</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns --></div></div>
	<!-- /wp:media-text -->',
