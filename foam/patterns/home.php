...
<h2 class="wp-block-heading alignwide has-text-align-center"><?php esc_html_e('Sign up for FOAM_ Digital and guarantee your attendance.', 'foam');?></h2>
<!-- /wp:heading -->

<!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
<div class="wp-block-group alignwide"><!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e('The Future of Online Apprenticeship and Mentorship groundbreaking digital conference that is set to redefine the way we connect, learn, and collaborate in the ever-evolving digital landscape is back in 2023.', 'foam');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e('Sign Up', 'foam');?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
