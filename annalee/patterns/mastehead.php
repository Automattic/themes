...
<div class="wp-block-columns alignwide">
	...
	<div class="wp-block-column">
		...
		<p class="has-small-font-size" style="margin-top:var(--wp--preset--spacing--30);letter-spacing:0.04em;text-transform:uppercase"><?php echo esc_html__( 'What I do', 'annalee' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:column -->
	...
	<div class="wp-block-column" style="flex-basis:65.16%">
		...
		<h1 class="wp-block-heading has-xxxx-large-font-size" style="line-height:0.89;text-transform:uppercase"><?php echo esc_html__( 'Mindset performance coaching', 'annalee' ); ?></h1>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:column -->
</div>
...
<div class="wp-block-columns alignwide">
	...
	<div class="wp-block-column">
		...
		<p style="text-transform:none"><?php echo esc_html__( 'Hi, I&rsquo;m Annalee, your partner on this exciting journey to self-discovery and success.', 'annalee' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:paragraph -->
		<p><?php echo esc_html__( 'With personalised mindset coaching, we&rsquo;ll work together to break through barriers, harness your unique potential, and help you achieve your personal and professional goals. I&rsquo;m here to guide you every step of the way. Let&rsquo;s embark on this adventure together.', 'annalee' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:paragraph -->
		<p><a href="#"><?php echo esc_html__( 'More about me', 'annalee' ); ?></a></p>
		<!-- /wp:paragraph -->

		<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","orientation":"vertical"}} -->
		<div class="wp-block-group">
			<!-- wp:paragraph {"fontSize":"small"} -->
			<p class="has-small-font-size"><?php echo esc_html__( 'Connect with me:', 'annalee' ); ?></p>
			<!-- /wp:paragraph -->
