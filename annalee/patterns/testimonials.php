...
<div class="wp-block-group alignwide">
	...
	<p class="has-small-font-size" style="letter-spacing:0.04em;text-transform:uppercase"><?php echo esc_html__( 'What folks are saying about Annalee', 'annalee' ); ?></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
...
<div class="wp-block-columns alignwide">
	...
	<div class="wp-block-column">
		...
		<div class="wp-block-group" style="min-height:100%">
			...
			<div class="wp-block-group">
				...
				<p class="has-x-large-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html__( 'Clarity and confidence', 'annalee' ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'With Annalee’s coaching, I found clarity and confidence I never knew I had. Her insight led me to success beyond my wildest dreams.', 'annalee' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<p style="font-style:normal;font-weight:500"><?php echo esc_html__( 'Kai Willmott', 'annalee' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph -->
					<p><?php echo esc_html__( 'Agency founder', 'annalee' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
	...
	<div class="wp-block-column">
		...
		<div class="wp-block-group" style="min-height:100%">
			...
			<div class="wp-block-group">
				<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"x-large"} -->
				<p class="has-x-large-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html__( 'My life has transformed', 'annalee' ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Working with Annalee unlocked possibilities I never imagined. My life has transformed, both personally and professionally.', 'annalee' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
					<p style="font-style:normal;font-weight:500"><?php echo esc_html__( 'Cate Moony', 'annalee' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph -->
					<p><?php echo esc_html__( 'Project manager', 'annalee' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
	...
	<div class="wp-block-column">
		...
		<div class="wp-block-group" style="min-height:100%">
			...
			<div class="wp-block-group">
				<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"x-large"} -->
				<p class="has-x-large-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html__( 'Turning point', 'annalee' ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Annalee&rsquo;s guidance was a turning point in my career. I&rsquo;ve achieved goals that seemed unreachable before our sessions.', 'annalee' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
					<p style="font-style:normal;font-weight:500"><?php echo esc_html__( 'Nate Willmott', 'annalee' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph -->
					<p><?php echo esc_html__( 'Designer', 'annalee' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
