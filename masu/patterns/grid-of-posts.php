	...
	<!-- wp:post-template -->
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group">
				...
				<!-- wp:post-title {"isLink":true,"style":{"typography":{"lineHeight":"1.6","fontStyle":"normal","fontWeight":"600"},"elements":{"link":{"color":{"text":"var:preset|color|black"}}}},"fontSize":"small"} /-->
