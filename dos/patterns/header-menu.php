 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"2rem","right":"4rem","left":"4rem","bottom":"1.4rem"},"blockGap":"2rem","margin":{"top":"0px","bottom":"0px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="margin-top:0px;margin-bottom:0px;padding-top:2rem;padding-right:4rem;padding-bottom:1.4rem;padding-left:4rem"><!-- wp:group {"align":"full","layout":{"type":"constrained","justifyContent":"center"}} -->
<div class="wp-block-group alignfull"><!-- wp:columns {"isStackedOnMobile":false,"align":"full","style":{"spacing":{"padding":{"top":"0px","right":"4rem","bottom":"0px","left":"4rem"},"margin":{"top":"0px","bottom":"0px"},"blockGap":{"top":"0px","left":"0px"}}}} -->
<div class="wp-block-columns alignfull is-not-stacked-on-mobile" style="margin-top:0px;margin-bottom:0px;padding-top:0px;padding-right:4rem;padding-bottom:0px;padding-left:4rem"><!-- wp:column {"width":"80px","style":{"border":{"color":null,"style":null,"width":null,"top":{"color":"var:preset|color|primary","style":"solid","width":"1px"},"right":{"color":"var:preset|color|primary","style":"solid","width":"1px"},"bottom":[],"left":{"color":"var:preset|color|primary","style":"solid","width":"1px"}}}} -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"right":"4rem","left":"4rem"}}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group alignfull" style="padding-right:4rem;padding-left:4rem"><!-- wp:group {"layout":{"type":"constrained"}} -->
...
<p style="font-size:1.2rem">is a blog theme designed by Automattic.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
