...
<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--60)">
	...
	<h2 class="wp-block-heading has-source-sans-3-font-family has-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:0px"><?php echo esc_html__( 'Latest Posts', 'alleyoop' ); ?></h2>
	<!-- /wp:heading -->
