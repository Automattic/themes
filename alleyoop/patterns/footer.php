...
<h1 class="wp-block-heading" style="font-size:5.37rem;line-height:0.9;text-transform:uppercase"><?php echo esc_html__( 'Join', 'alleyoop' ); ?><br><?php echo esc_html__( 'our Club', 'alleyoop' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'We offer men\'s and coed basketball leagues with levels varying from recreational to competitive. We play at multiple locations all over the city. Whether you are looking to explore Chicago or find one in your local neighborhood we have you covered.', 'alleyoop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-group"><!-- wp:heading {"style":{"typography":{"fontSize":"0.88rem","textTransform":"uppercase"}}} -->
<h2 class="wp-block-heading" style="font-size:0.88rem;text-transform:uppercase"><?php echo esc_html__( 'Where', 'alleyoop' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'West 4th Street Courts', 'alleyoop' ); ?><br><?php echo esc_html__( '272 6th Ave, New York', 'alleyoop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"layout":{"selfStretch":"fill","flexSize":null}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"0.88rem","textTransform":"uppercase"}}} -->
<h3 class="wp-block-heading" style="font-size:0.88rem;text-transform:uppercase"><?php echo esc_html__( 'When', 'alleyoop' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Tuesdays and Thursdays', 'alleyoop' ); ?><br><?php echo esc_html__( 'Starting at 17:00', 'alleyoop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-50"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Read more', 'alleyoop' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<div class="wp-block-group has-contrast-background-color has-background" style="padding-top:1.5rem;padding-right:1rem;padding-bottom:1.5rem;padding-left:1rem"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php echo esc_html__( 'Designed with', 'alleyoop' ); ?><a href="https://wordpress.org" rel="nofollow"><?php echo esc_html__( 'WordPress', 'alleyoop' ); ?></a>	</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
