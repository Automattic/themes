...
<h1 class="wp-block-heading" style="font-size:5.37rem;line-height:0.9;text-transform:uppercase"><?php esc_html_e('Join our Club', 'alleyoop');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p><?php esc_html_e('West 4th Street Courts', 'alleyoop');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e('272 6th Ave, New York', 'alleyoop');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<div class="wp-block-group"><!-- wp:paragraph -->
<p><?php esc_html_e('Tuesdays and Thursdays', 'alleyoop');?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Starting at 17:00', 'alleyoop');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<p class="has-base-color has-text-color has-link-color has-small-font-size"><?php esc_html_e('Designed with WordPress', 'alleyoop');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
