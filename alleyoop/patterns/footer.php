...
<h1 class="wp-block-heading" style="font-size:5.37rem;line-height:0.9;text-transform:uppercase">Join<br>our Club</h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph -->
<p>We offer men's and coed basketball leagues with levels varying from recreational to competitive. We play at multiple locations all over the city. Whether you are looking to explore Chicago or find one in your local neighborhood we have you covered.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h2 class="wp-block-heading" style="font-size:0.88rem;text-transform:uppercase">Where</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>West 4th Street Courts<br>272 6th Ave, New York</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading" style="font-size:0.88rem;text-transform:uppercase">When</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Tuesdays and Thursdays<br>Starting at 17:00</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-50"><a class="wp-block-button__link wp-element-button">Read more</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
