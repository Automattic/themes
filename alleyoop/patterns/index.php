...
<div class="wp-block-group alignwide" style="padding-top:0rem;padding-bottom:0rem"><!-- wp:heading {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}},"typography":{"fontSize":"0.88rem","letterSpacing":"0px"}},"textColor":"contrast","fontFamily":"hezaedrus"} -->
<h2 class="wp-block-heading has-contrast-color has-text-color has-link-color has-hezaedrus-font-family" style="font-size:0.88rem;letter-spacing:0px"><?php esc_html_e('News', 'alleyoop');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:query {"queryId":0,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"enhancedPagination":true,"align":"wide"} -->
