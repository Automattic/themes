...
<div class="wp-block-group alignwide"><!-- wp:navigation {"textColor":"contrast","overlayMenu":"never","overlayBackgroundColor":"base","layout":{"type":"flex","orientation":"horizontal","justifyContent":"left"},"style":{"spacing":{"blockGap":"var:preset|spacing|50"},"layout":{"selfStretch":"fill","flexSize":null}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
