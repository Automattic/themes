...
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Football_SandroSchuh-1.png","id":218,"dimRatio":0,"isUserOverlayColor":true,"minHeight":65,"minHeightUnit":"vh","contentPosition":"bottom center","isDark":false,"style":{"spacing":{"padding":{"bottom":"0rem","top":"5vh","right":"0","left":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-light has-custom-content-position is-position-bottom-center" style="padding-top:5vh;padding-right:0;padding-bottom:0rem;padding-left:0;min-height:65vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-218" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Football_SandroSchuh-1.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"wide","style":{"dimensions":{"minHeight":""},"spacing":{"blockGap":"0vh"}},"layout":{"type":"constrained"}} -->
