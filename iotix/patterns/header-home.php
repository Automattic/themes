 ...
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Hero-Image.png","id":9,"dimRatio":40,"overlayColor":"custom-cover-overlay","minHeight":100,"minHeightUnit":"vh","contentPosition":"center center","style":{"spacing":{"padding":{"right":"0vw","left":"0vw"}}}} -->
<div class="wp-block-cover" style="padding-right:0vw;padding-left:0vw;min-height:100vh"><span aria-hidden="true" class="wp-block-cover__background has-custom-cover-overlay-background-color has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-9" alt="" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Hero-Image.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group has-link-color" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:navigation {"ref":5,"overlayBackgroundColor":"primary","overlayTextColor":"tertiary"} /-->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"background","textColor":"primary","className":"is-style-fill","fontSize":"small"} -->
<div class="wp-block-button has-custom-font-size is-style-fill has-small-font-size"><a class="wp-block-button__link has-primary-color has-background-background-color has-text-color has-background wp-element-button">Sign In</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-columns alignwide" style="padding-top:11rem;padding-bottom:11rem"><!-- wp:column {"width":"35%"} -->
...
<h2 class="wp-block-heading alignwide has-text-align-center" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-right:0;padding-bottom:0;font-size:3rem;line-height:1">Machine learning for designers, made easy.</h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-medium-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:var(--wp--preset--spacing--50);padding-right:0vw;padding-bottom:var(--wp--preset--spacing--50)">Speed up your design process by creating realistic mockups with AI-driven content, all through the power of machine learning.</p>
<!-- /wp:paragraph -->
