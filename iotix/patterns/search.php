...
<div class="wp-block-group alignwide"><!-- wp:search {"showLabel":false,"widthUnit":"%","align":"left","style":{"border":{"radius":"100px"}},"backgroundColor":"foreground"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p><?php echo __('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'iotix');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- /wp:query-no-results -->
