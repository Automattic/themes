...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:image {"width":"200px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/5c210-logo_1-1.png" alt="<?php esc_html_e('', 'iotix');?>" class="" style="width:200px"/></figure>
<!-- /wp:image -->

<!-- wp:image {"width":"200px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/6d5df-logo_2.png" alt="<?php esc_html_e('', 'iotix');?>" class="" style="width:200px"/></figure>
<!-- /wp:image -->

<!-- wp:image {"width":"200px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/85363-logo_3.png" alt="<?php esc_html_e('', 'iotix');?>" class="" style="width:200px"/></figure>
<!-- /wp:image -->

<!-- wp:image {"width":"200px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/28ce4-logo_4-1.png" alt="<?php esc_html_e('', 'iotix');?>" class="" style="width:200px"/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Not a programmer? Use our intuitive, designer-first UI.', 'iotix');?></p>
<!-- /wp:paragraph -->

<!-- wp:image {"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/f24d9-column_1_image.webp" alt="<?php esc_html_e('', 'iotix');?>" class=""/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Compatible with all of your favourite design programs.', 'iotix');?></p>
<!-- /wp:paragraph -->

<!-- wp:image {"sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/32721-column_2_image-1.webp" alt="<?php esc_html_e('', 'iotix');?>" class=""/></figure>
<!-- /wp:image -->
...
<!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/92de6-startup-hero-03.webp","dimRatio":80,"overlayColor":"custom-cover-overlay","isUserOverlayColor":true,"align":"wide","style":{"spacing":{"padding":{"right":"5vw","left":"5vw"}}},"layout":{"type":"default"}} -->
<div class="wp-block-cover alignwide" style="padding-right:5vw;padding-left:5vw"><span aria-hidden="true" class="wp-block-cover__background has-custom-cover-overlay-background-color has-background-dim-80 has-background-dim"></span><img class="wp-block-cover__image-background " alt="<?php esc_html_e('', 'iotix');?>" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/92de6-startup-hero-03.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"top":"10rem","right":"0","bottom":"10rem","left":"0"}}},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading alignwide has-text-align-center"><?php esc_html_e('Keep learning as you go.', 'iotix');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
<p class="has-text-align-center has-medium-font-size"><?php esc_html_e('Want to be first in line to learn tips and tricks for supercharging your mockups with Desaign? There are many helpful resources in our blog.', 'iotix');?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"style":{"spacing":{"blockGap":"1.6em"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"0.6em"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"textColor":"background"} -->
<h3 class="wp-block-heading has-background-color has-text-color"><?php esc_html_e('Join the community', 'iotix');?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"background"} -->
<p class="has-background-color has-text-color"><?php esc_html_e('A caring designer community to share knowledge with.', 'iotix');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"background","textColor":"primary"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-primary-color has-background-background-color has-text-color has-background wp-element-button"><?php esc_html_e('Visit forums', 'iotix');?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
